...
public class ItemRenderFlashersWithGate implements IItemRenderer {
	private static final ModelFlashersWithGate modeSwitch = new ModelFlashersWithGate();
	...
	public ItemRenderFlashersWithGate() {
	}
