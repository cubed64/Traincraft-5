...
public class ItemRenderStandardCantilever2 implements IItemRenderer {
    private static final ModelStandardCantilever2 modeSwitch = new ModelStandardCantilever2();
    ...
    public ItemRenderStandardCantilever2() {
    }
