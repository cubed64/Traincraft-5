...
public class ItemRenderStandardCrossingArm implements IItemRenderer {
	private static final ModelStandardCrossingArm modeSwitch = new ModelStandardCrossingArm();
	...
	public ItemRenderStandardCrossingArm() {
	}
