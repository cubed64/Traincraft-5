...
public class RenderMediumCantileverLeft extends TileEntitySpecialRenderer {
    private long updateTicks = 0;
    private boolean flip = true;
    private static final ModelMediumCantileverLeft modelSwitch = new ModelMediumCantileverLeft();
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        ...
        TileMediumCantileverLeft tile = ((TileMediumCantileverLeft)tileEntity);
