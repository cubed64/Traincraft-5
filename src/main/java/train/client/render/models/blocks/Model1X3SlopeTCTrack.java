...
public class Model1X3SlopeTCTrack extends ModelBase
{
    ...
    public Model1X3SlopeTCTrack()
    {
        modeltrack = net.minecraftforge.client.model.AdvancedModelLoader.loadModel(new ResourceLocation(Info.modelPrefix + "track_slope_1x3.obj"));
        modelSlopeBallast = net.minecraftforge.client.model.AdvancedModelLoader
                .loadModel(new ResourceLocation(Info.modelPrefix + "track_slope_1x3_ballast.obj"));
    }
