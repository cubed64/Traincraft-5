...
public class RenderStandardCantilever3 extends TileEntitySpecialRenderer {
    private long updateTicks = 0;
    private boolean flip = true;
    private static final ModelStandardCantilever3 modelSwitch = new ModelStandardCantilever3();
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        ...
        TileStandardCantilever3 tile = ((TileStandardCantilever3)tileEntity);
