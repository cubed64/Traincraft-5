...
public class RenderCrossingBase extends TileEntitySpecialRenderer {
	private long updateTicks = 0;
	private boolean flip = true;
	private static final ModelCrossingBase modelSwitch = new ModelCrossingBase();
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		...
		TileCrossingBase tile = ((TileCrossingBase)tileEntity);
