...
import train.client.render.models.blocks.Crossings.ModelFlashersWithGate;
import train.common.library.Info;
import train.common.tile.tileSwitch.TileFlashersWithGate;

public class RenderFlashersWithGate extends TileEntitySpecialRenderer {
	private long updateTicks = 0;
	private boolean flip = true;
	private static final ModelFlashersWithGate modelSwitch = new ModelFlashersWithGate();
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		...
		TileFlashersWithGate tile = ((TileFlashersWithGate)tileEntity);
