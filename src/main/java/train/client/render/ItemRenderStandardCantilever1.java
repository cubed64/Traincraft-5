...
import train.client.render.models.blocks.Crossings.ModelStandardCantilever1;
import train.common.library.Info;

public class ItemRenderStandardCantilever1 implements IItemRenderer {
    private static final ModelStandardCantilever1 modeSwitch = new ModelStandardCantilever1();
    ...
    public ItemRenderStandardCantilever1() {
    }
    ...
    private void renderSwitch(float x, float y, float z, float scale) {
        ...
        GL11.glTranslatef(x-0.25f, y+0f, z-.25f);
        GL11.glScalef(scale*.7f, scale*.7f, scale*.7f);
