...
public class TileReceiverMTC extends TileEntity implements IPeripheral {
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound) {
        ...
        this.trainLevel = nbttagcompound.getInteger("trainLevel");
    ...
    //    nbttagcompound.setBoolean("isActivated", this.isActivated);
     //   nbttagcompound.setInteger("setSpeed", this.setSpeed);
        ...
        nbttagcompound.setInteger("trainLevel", this.trainLevel);
