...
public class TileInstructionRadio extends TileEntity implements IPeripheral, WirelessTransmitter {
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments) throws LuaException, InterruptedException {
        switch(method) {
            case 0: {
                ...
                sendMessage(new MTCMessage(this.uniqueID, arguments[0].toString(), arguments[1].toString(), 1 ));
                return new Object[]{true};
            } case 3 : {
    ...
    public void sendMessage(MTCMessage message) {
        //System.out.println("Attempting to send..");
            for (WirelessTransmitter wt :  getWirelessTransmittersInBoundingBox()) {
                ...
                } else if (wt instanceof TileInstructionRadio) {
                ...
                if (wt instanceof Locomotive) {
                    ...
                    //    System.out.println("Both of those match! Sending message..");
                      wt.receiveMessage(new MTCMessage(this.uniqueID, message.UUIDTo, message.message, system));
                    }
                } else if (wt instanceof TileInstructionRadio) {

                   TileInstructionRadio actualRadio = (TileInstructionRadio)wt;
        ...
        while(iterator.hasNext()) {
           TileEntity te = iterator.next();
            if (te instanceof TileInstructionRadio) {
                ...
                toAdd.add((TileInstructionRadio)te);
            }
        }
       //System.out.println("Got some..");
