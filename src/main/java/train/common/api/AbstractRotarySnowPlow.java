...
public abstract class AbstractRotarySnowPlow extends ElectricTrain
{
    public AbstractRotarySnowPlow(World world)
    {
        super(world);
        specialRenderMode = 100;
    }
    ...
    private static final double[][]	blockpos	= { { 3, 0, 1 }, { 3, 0, -1 }, { 3, 0, 0 }};//which blocks in front of it get snow removed, f/b, u/d, l/r
