...
public class TileTraincraftWithInventory extends TileTraincraft implements ISidedInventory
{
    public ItemStack[] slots;
    public String invName;

    public TileTraincraftWithInventory(){}

    public TileTraincraftWithInventory(int slotAmount, String inventoryname){
