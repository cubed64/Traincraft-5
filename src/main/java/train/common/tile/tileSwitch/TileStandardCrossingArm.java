...
public class TileStandardCrossingArm extends TileMFPBWigWag {
    ...
    EntityItem entity = new EntityItem(worldObj, this.xCoord, this.yCoord + 1, this.zCoord, new ItemStack(Item.getItemFromBlock(BlockIDs.StandardCrossingArm.block), 1));
