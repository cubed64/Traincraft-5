...
public class TilePedestrianCrossing extends TileMFPBWigWag {

    private long updateTicks = 0;
    public boolean powered =false;
    public boolean flip = true;
    private static final ResourceLocation textureOn = new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Crossings/PedestrianCrossingLeft.png");
    private static final ResourceLocation textureOn1 = new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Crossings/PedestrianCrossingRight.png");
