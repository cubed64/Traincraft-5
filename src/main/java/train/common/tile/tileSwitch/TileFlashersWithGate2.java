...
public class TileFlashersWithGate2 extends TileMFPBWigWag {
    ...
    EntityItem entity = new EntityItem(worldObj, this.xCoord, this.yCoord + 1, this.zCoord, new ItemStack(Item.getItemFromBlock(BlockIDs.StandardCrossingArm2.block), 1));
