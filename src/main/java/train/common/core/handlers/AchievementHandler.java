...
public class AchievementHandler {
	...
	public static void load() {
		...
		AchievementIDs.geared.achievement = achievement("geared", 2, 4, ItemIDs.minecartVBShay2.item, AchievementIDs.normalSteam.achievement);
		...
		AchievementIDs.polar.achievement = achievement("polar", -2, 8, ItemIDs.minecartPMNandN1.item, AchievementIDs.normalSteam.achievement).setSpecial();
		...
		AchievementIDs.refined.achievement = achievement("refined", -8, 4, ItemIDs.refinedFuel.item, AchievementIDs.dieselFuel.achievement);
		...
		AchievementIDs.fast.achievement = achievement("fast", -9, 10, ItemIDs.minecartAEM7.item, AchievementIDs.electMotor.achievement);


		AchievementIDs.engineer.achievement = achievement("engineer", -2, -2, ItemIDs.overalls.item, null);
		AchievementIDs.zeppelin.achievement = achievement("zeppelin", 3, -2, ItemIDs.airship.item, null).setSpecial();
		AchievementIDs.thanos.achievement = achievement("thanos", 10, 0, ItemIDs.minecartThanos.item, null).setSpecial();
		...
		AchievementIDs.passenger.achievement = achievement("passenger", 6, 2, ItemIDs.minecartACFGN60SeatCoach.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.freight.achievement = achievement("freight", 8, 2, ItemIDs.minecartACFRailbox.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.liquid.achievement = achievement("liquid", 6, 4, ItemIDs.minecartNATX30600.item, AchievementIDs.assemblyTable.achievement);
		...
		AchievementIDs.workCart.achievement = achievement("workCart", 6, 6, ItemIDs.minecartWork.item, AchievementIDs.assemblyTable.achievement);
		...
		AchievementIDs.jukebox.achievement = achievement("jukebox", 6, 8, ItemIDs.minecartJukeBoxCart.item, AchievementIDs.assemblyTable.achievement).setSpecial();
		...
		AchievementIDs.mail.achievement = achievement("mail", 8, 10, ItemIDs.minecartPSCNWRPO60.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.stockCar.achievement = achievement("stockcar", 6, 12, ItemIDs.minecartStampedeRack.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.caboose.achievement = achievement("caboose", 8, 12, ItemIDs.minecartDRGWCaboose.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.flatCart.achievement = achievement("flatCart", 6, 14, ItemIDs.minecartGunderson89ftFlat.item, AchievementIDs.assemblyTable.achievement);
		...
		AchievementIDs.jenny.achievement = achievement("jenny", 8,  16, ItemIDs.minecartOreJenny.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.intermodal.achievement = achievement("intermodal", 6,  16, ItemIDs.minecartHuskyStackWellcar.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.railwhale.achievement = achievement("railwhale", 6,  18, ItemIDs.minecartDUPX39200.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.reefer.achievement = achievement("reefer", 8,  18, ItemIDs.minecartR70Reefer.item, AchievementIDs.assemblyTable.achievement);
		AchievementIDs.automobile.achievement = achievement("automobile", 6,  20, ItemIDs.minecartGunderson89ftAutorack.item, AchievementIDs.assemblyTable.achievement);
		...
		Achievement ach[] = new Achievement[] { AchievementIDs.steel.achievement, AchievementIDs.stake.achievement,
				...
				AchievementIDs.intermodal.achievement, AchievementIDs.railwhale.achievement, AchievementIDs.reefer.achievement,
				AchievementIDs.automobile.achievement
		};
