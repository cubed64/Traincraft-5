...
import train.common.library.TraincraftItemRegistry;

import java.util.List;

public class GenericCreativeTabTraincraft extends CreativeTabs {
    public Item tabItem;

    /**instances the tab by handling it through the super.*/
    public GenericCreativeTabTraincraft(String name, String MODID, String textureName) {
        super(CreativeTabs.getNextID(), name);
        tabItem = TraincraftItemRegistry.RegisterItem(new Item(),MODID,textureName,null);
