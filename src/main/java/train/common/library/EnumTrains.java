...
public enum EnumTrains implements ITrainRecord
{
	...
	GP20("GP20", DieselGP20.class, ItemIDs.minecartGP20.item, "diesel", 2000, 105, 0, 30, 0, 200, 0.80, 0.85, 18000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey","Orange","Yellow","Red","Black","Blue","Skin17","Skin18","Skin19","Skin20"}), 16, -2.9),
