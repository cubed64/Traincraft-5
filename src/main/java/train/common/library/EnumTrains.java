...
public enum EnumTrains {
	...
	SD9("SD9", DieselSD9.class, ItemIDs.minecartSD9.item, "diesel", 1750, 104, 0, 35, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Black", "Orange", "Skin17", "Cyan", "LightGrey", "Skin18", "Yellow", "Magenta", "Skin19", "Skin20", "Pink"}), 14, -3.05),
	...
	SD70ACe("SD70ACe", DieselSD70ACe.class, ItemIDs.minecartSD70ACe.item, "diesel", 4300, 110, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Blue", "LightBlue", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Black", "Skin27"}), 12, -4.0),
	...
	U18Balt("U18Balt", DieselU18Balt.class, ItemIDs.minecartU18Balt.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Cyan", "White", "LightGrey", "Skin16", "Skin17", "Skin18", "Lime"}), 16, -2.6),
	...
	PCF_RBL_Smooth("PCF_RBL_Smooth", PCF_RBL_Smooth.class, ItemIDs.minecartPCF_RBL_Smooth.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Brown", "Skin16", "Skin17", "Green", "Cyan", "Skin22", "Skin18", "Skin19", "Skin20", "Skin21", "Yellow", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28"}), 10, 45, (new String[] {"Cargo: Any."})),
	PCF_RBL_Ribbed("PCF_RBL_Ribbed", PCF_RBL_Ribbed.class, ItemIDs.minecartPCF_RBL_Ribbed.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Brown"}), 10, 45, (new String[] {"Cargo: Any."})),
	...
	ICC_Bobber("ICC_Bobber",ICC_Bobber.class, ItemIDs.minecartICC_Bobber.item, "caboose", 2, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Red", "Green"}), 16, 0, null),
