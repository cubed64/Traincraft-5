...
public enum EnumTrains {
	...
	SD50("SD50", DieselSD50.class, ItemIDs.minecartSD50.item, "diesel", 3600, 142, 0, 20, 0, 200, 0.75, 0.85, 23000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Pink", "Blue", "LightBlue", "Brown", "Black", "White", "LightGrey"}), 12, -3.725),
	SD60("SD60", DieselSD60.class, ItemIDs.minecartSD60.item, "diesel", 3800, 113, 0, 20, 0, 200, 0.75, 0.85, 23000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Skin16", "Red", "Yellow", "Brown", "LightBlue", "LightGrey"}), 12, -3.725),
