...
public enum EnumTrains {
	...
	CF7angle("CF7angle", DieselCF7angle.class, ItemIDs.minecartCF7angle.item, "diesel", 1500, 116, 0, 25, 0, 200, 0.65, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Skin29", "Red", "LightGrey", "White", "Green", "Brown", "Skin16", "Skin17", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Black", "Grey", "Cyan", "Skin22", "Skin24", "Magenta", "Pink", "Lime", "Skin25", "Purple", "LightBlue", "Skin26", "Skin27", "Skin28", "Skin30", "Skin31", "Skin32", "Skin33", "Skin34", "Skin35", "Skin36", "Skin37", "Skin38", "Skin39", "Skin40"}), 15, -2.5),
	CF7round("CF7round", DieselCF7round.class, ItemIDs.minecartCF7round.item, "diesel", 1500, 116, 0, 25, 0, 200, 0.65, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Yellow", "Skin18", "White", "Grey", "Pink", "Cyan", "Skin19", "Skin24", "LightBlue", "Lime", "Skin16", "Skin17", "Skin20"}), 15, -2.5),
	...
	GP38("GP38", DieselGP38.class, ItemIDs.minecartGP38.item, "diesel", 2000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"LightGrey", "Cyan", "Grey", "Skin18", "Skin26", "Skin21", "Skin22", "Skin23", "Skin24", "Magenta", "Skin27", "Skin28"}), 14, -2.9),
	...
	GP39("GP39", DieselGP39.class, ItemIDs.minecartGP39.item, "diesel", 2300, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Grey", "Blue"}), 14, -2.9),
	...
	SW10("SW10", DieselSW10.class, ItemIDs.minecartSW10.item, "diesel", 1200, 81, 0, 45, 0, 200, 0.85, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "LightGrey", "Cyan", "Skin17", "Skin18"}), 16, -2.0),
	...
	U18BWH("U18BWH", DieselU18BWH.class, ItemIDs.minecartU18BWH.item, "diesel", 2250, 188, 0, 30, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Pink", "LightGrey"}), 14, -3.1),
	...
	U23BW("U23BW", DieselU23BW.class, ItemIDs.minecartU23BW.item, "diesel", 2250, 113, 0, 30, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey"}), 14, -3.1),
	...
	U30C("U30C", DieselU30C.class, ItemIDs.minecartU30C.item, "diesel", 3000, 113, 0, 20, 0, 200, 0.7, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "Cyan", "Grey", "Skin17", "Skin18", "Lime"}), 12, -3.3),
	...
	Dash840C("Dash840C", DieselDash840C.class, ItemIDs.minecartDash840C.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.8, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Grey", "LightBlue", "Blue", "Skin16", "LightGrey", "Skin17", "Purple"}), 12, -4),
	...
	S12("S12", DieselS12.class, ItemIDs.minecartS12.item, "diesel", 1200, 97, 0, 35, 0, 180, 0.75, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "Brown", "Skin16", "White", "Cyan", "Skin17"}), 16, -2.2),
	...
	GM6C("GM6C",ElectricGM6C_2.class, ItemIDs.minecartGM6C.item, "electric", 6000, 115, 0, 55, 0, 200, 0.65, 0.79, 12500, TraincraftUtil.getBytesFromColors(new String[] {"White", "LightGrey"}), 12, -3.45),
	...
	gsco67millgon("67millgon", gsco67millgon.class, ItemIDs.minecart67millgon.item, "freight", 3.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Green", "Brown", "Blue", "Grey"}), 12, 45, (new String[] {"Cargo: Any."})),
	...
	HuskyStackWellcar("40ftHuskyStackWellcar", HuskyStack2.class, ItemIDs.minecartHuskyStackWellcar.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Blue", "Brown", "Green", "Pink", "Skin16"}), 10,0, (new String[] {"Will carry containers (for REAL) Eventually!"})),
	...
	OB92SeatCoach("OB 92 Seat Coach", OB92SeatCoach.class, ItemIDs.minecartOB92SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Black", "White", "Yellow"}), 10, 0, null),
	...
	Class74("Class74",ElectricClass74.class, ItemIDs.minecartClass74.item, "electric", 2426, 140, 0, 50, 0, 10, 0.6, 0.7, 13, TraincraftUtil.getBytesFromColors(new String[] {"Blue"}), 10, -2),
