...
public enum EnumTrains {
	...
	CF7angle3("CF7angle3", DieselCF7angle3.class, ItemIDs.minecartCF7angle3.item, "diesel", 1500, 116, 0, 25, 0, 200, 0.65, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Pink", "Cyan", "Skin22", "Yellow", "Skin26", "Skin36", "Skin37", "Skin28", "LightGrey", "Skin30", "Skin31", "Skin39", "Skin40", "Skin35", "Skin24", "Grey", "Lime", "Skin25", "Skin32"}), 15, -2.5),
