...
public enum EnumTrains implements IEnumTrains
{
	...
	ACF2Bay("ACF2Bay", ACF2Bay.class, ItemIDs.minecartACF2Bay.item, "Covered Hopper", 2.5, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "Black", "Magenta", "Skin16", "Grey", "Red", "Orange", "Skin17", "Skin18", "Blue", "Skin19", "Skin20", "Brown"}), 15, 27,(new String[] {"Cargo: Any."})),
