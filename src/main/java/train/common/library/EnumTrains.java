...
public enum EnumTrains implements IEnumTrains
{
	...
	HCS_9k_Tender("HCS_9k_Tender", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tender.HCS_9k_Tender.class, ItemIDs.minecartHCS_9k_Tender.item,"tender",0,0,4,0,0,0,0,0,34000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16", "Skin17", "Skin18", "Skin19"}),18,0, (new String[] {"Water capacity: 34000mb."})),
