...
public enum EnumTrains {
	...
	GP38Dash2("GP38Dash2", DieselGP38dash2.class, ItemIDs.minecartGP38dash2.item, "diesel", 2000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow", "Green", "Skin16", "Blue", "Black", "Skin17", "Skin19", "Skin20", "Orange", "Skin25", "Skin29"}), 14, -3.1),
