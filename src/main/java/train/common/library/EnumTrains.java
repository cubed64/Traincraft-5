...
public enum EnumTrains {
	...
	ACF4650("ACF4650", ACF4650.class, ItemIDs.minecartACF4650.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Grey", "LightGrey", "Skin16", "Skin17", "Brown"}), 15, 36,(new String[] {"Cargo: Any."})),
