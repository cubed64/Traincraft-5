...
public enum EnumTrains {
	...
	SB18E("SB18E", DieselSB18E.class, ItemIDs.minecartSB18E.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Blue"}), 16, -2.6),
