...
public enum EnumTrains implements ITrainRecord
{
	...
	B36("B36-7", DieselB36.class, ItemIDs.minecartB36.item, "diesel", 3600, 113, 0, 20, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin30", "Skin31", "Skin40", "Skin38", "Skin41", "Skin36", "Skin39"}), 14, -3.1),
