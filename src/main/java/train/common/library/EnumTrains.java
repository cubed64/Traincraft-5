...
public enum EnumTrains implements IEnumTrains
{
	...
	//EMD//
	F3A("F3A", DieselF3A.class, ItemIDs.minecartF3A.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Magenta", "Grey", "Cyan"}), 18, -2.6),
	...
	SF30B("SF30B", DieselSF30B.class, ItemIDs.minecartSF30B.item, "diesel", 3000, 113, 0, 30, 0, 160, 0.75, 0.86, 25000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Brown", "Skin16"}), 14, -3.1),
	...
	U30C("U30C", DieselU30C.class, ItemIDs.minecartU30C.item, "diesel", 3000, 113, 0, 20, 0, 200, 0.7, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "Cyan", "Grey", "Skin17", "Skin18", "Lime", "Orange", "Skin19", "Skin20"}), 12, -3.3),
	...
	B30("B30-7", DieselB30.class, ItemIDs.minecartB30.item, "diesel", 3000, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin34", "Skin31", "Blue"}), 14, -3.1),
	B36("B36-7", DieselB36.class, ItemIDs.minecartB36.item, "diesel", 3600, 113, 0, 20, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin30", "Skin31"}), 14, -3.1),
	...
	Dash839C("Dash839C", DieselDash839C.class, ItemIDs.minecartDash839C.item, "diesel", 3900, 120, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "Black", "Blue", "Skin17", "Cyan", "LightGrey", "Skin16", "Brown", "Orange", "Skin18"}), 12, -4.0),
	...
	Dash840C("Dash840C", DieselDash840C.class, ItemIDs.minecartDash840C.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.8, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Grey", "LightBlue", "Blue", "Skin16", "LightGrey", "Skin17", "Purple", "Skin22", "Skin23"}), 12, -4),
	...
	ACF3500("ACF3500", ACF3500.class, ItemIDs.minecartACF3500.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Grey", "Yellow", "Skin17", "Pink", "Skin18", "Brown", "Skin19", "Orange", "Black", "LightGrey", "Skin20", "Skin21", "Skin22", "Skin23"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	Freight66centerbeam("66centerbeam",  Freight66centerbeam.class, ItemIDs.minecart66centerbeam.item, "Centerbeam Flat", 3, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Cyan", "Black", "Green", "Lime", "Red", "Purple", "LightBlue", "Pink", "Blue", "Yellow"}), 10, 54, (new String[] {"Cargo: Woodthings."})),
	...
	MaPa35FootFlatcar("MaPa_35Flatcar", MaPa35FootFlat.class, ItemIDs.minecartMaPa35FootFlatcar.item, "Flatcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Grey","Magenta", "LightGrey"}), 12, 18, (new String[] {"Cargo: whatever flatcars carry i guess"})),

	PS140("PS140", PS140.class, ItemIDs.minecartPS140.item, "Boxcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "LightBlue", "Green", "Cyan", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Yellow", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Magenta", "Skin26", "Skin27", "Skin28"}), 15, 27, (new String[] {"Cargo: Any."})),
	...
	NATX30600( "NATX30600", NATX30600.class, ItemIDs.minecartNATX30600.item, "Tankcar", 0, 0, 3.25, 0, 0, 0, 0, 0, 116000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Red", "Yellow", "Pink", "Skin16", "Skin17", "LightBlue", "Skin18"}), 12, 0, (new String[] {"Capacity: 116000mb."})),
	...
	DUPX39200( "DUPX39200", DUPX39200.class, ItemIDs.minecartDUPX39200.item, "Tankcar", 0, 0, 5, 0, 0, 0, 0, 0, 148000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "White", "Green", "Black"}), 10, 0, (new String[] {"Capacity: 148000mb."})),
