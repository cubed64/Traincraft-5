...
public enum EnumTrains {
	...
	SlugMA("SlugMA", SlugMA.class, ItemIDs.minecartSlugMA.item, "slug", 0, 0, 7, 0, 0, 0, 0, 0, 18000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Skin16", "Magenta"}), 10, 0, (new String[] {"Reduces weight carried by 70 tons when fueled"})),
