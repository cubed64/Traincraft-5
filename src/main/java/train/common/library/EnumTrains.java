...
public enum EnumTrains {
	...
	U23B("U23B", DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 113, 0, 25, 0, 180, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Grey", "Cyan", "Skin16", "Skin19", "LightBlue", "LightGrey", "Skin17", "Skin21", "Skin22", "Blue", "Magenta", "Black", "Pink", "Green", "Skin18", "Skin20", "Skin23"}), 14, -3.1),
