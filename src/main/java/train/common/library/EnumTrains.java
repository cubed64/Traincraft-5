...
public enum EnumTrains implements IEnumTrains
{
	...
	//EMD//
	F3A("F3A", DieselF3A.class, ItemIDs.minecartF3A.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Magenta", "Grey", "Cyan","Green"}), 18, -2.6),
	...
	GP30("GP30", DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 134, 0, 30, 0, 200, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Black", "Blue", "Skin23", "Skin24", "LightBlue", "Grey", "Skin17", "Yellow", "Green", "Skin18", "Skin16", "Purple", "Pink", "Red", "Skin19", "LightGrey", "Skin20", "Skin21", "Skin22", "Magenta", "Lime"}), 15, -2.9),
	...
	GP38("GP38", DieselGP38.class, ItemIDs.minecartGP38.item, "diesel", 2000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"LightGrey", "Cyan", "Grey", "Skin18", "Skin26", "Skin21", "Skin22", "Skin23", "Skin24", "Magenta", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Red", "Skin33", "Skin34", "Skin35"}), 14, -2.9),
	...
	GP40("GP40", DieselGP40.class, ItemIDs.minecartGP40.item, "diesel", 3000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Pink", "Red", "Skin20", "Grey", "Orange", "Skin21", "Skin22", "Green", "Magenta", "Skin19", "Skin23", "Skin24", "Skin25", "Skin28", "Skin30", "Skin32", "Skin33", "Skin34", "Cyan", "Skin35", "Lime", "Skin36", "Skin37"}), 14, -2.9),
	...
	SD40("SD40", DieselSD40.class, ItemIDs.minecartSD40.item, "diesel", 3000, 105, 0, 20, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "Skin16", "Red", "Skin17", "Cyan", "Black", "Skin18", "Skin20", "Skin21", "Skin22"}), 12, -3.45),
	SD40dash2("SD40-2", DieselSD40dash2.class, ItemIDs.minecartSD40dash2.item, "diesel", 3000, 105, 0, 20, 0, 200, 0.75, 0.85, 12000, TraincraftUtil.getBytesFromColors(new String[] {"Magenta", "Green", "White", "Skin18", "Yellow", "Orange", "Skin20", "Purple", "Skin21", "LightBlue", "Red", "Pink", "Black", "Skin22", "Skin23", "Skin16", "Skin17", "Skin19", "Brown", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32", "Skin33", "Skin34", "Skin35", "Skin36", "Skin37", "Skin38", "Lime"}), 12, -3.45),
	...
	U30C("U30C", DieselU30C.class, ItemIDs.minecartU30C.item, "diesel", 3000, 113, 0, 20, 0, 200, 0.7, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "Cyan", "Grey", "Skin17", "Skin18", "Lime", "Orange", "Skin19", "Skin20", "Yellow"}), 12, -3.3),
	...
	Freight40highcube("40highcube", Freight40highcube.class, ItemIDs.minecart40highcube.item, "Highcube Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Cyan", "Orange", "Grey", "Red", "Lime", "LightGrey", "Pink", "Purple", "Blue", "Black", "White", "Magenta", "Skin16", "Skin17","Skin18"}), 15, 40, (new String[] {"Cargo: Any."})),
	...
	ACFRailboxCushioned("ACF Railbox (Cushioned)", ACFRailboxCushioned.class, ItemIDs.minecartACFRailboxCushioned.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "White", "Brown", "Red", "Blue", "Grey", "Orange", "Yellow","Skin16"}), 12, 54, (new String[] {"Cargo: Any."})),
	...
	VersaLongi("VersaLongi", VersaLongi.class, ItemIDs.minecartVersaLongi.item, "Open Top Hopper", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Black", "Orange", "Brown", "Skin16", "Grey", "Pink"}), 15, 36, (new String[] {"Cargo: Aggregates."})),
