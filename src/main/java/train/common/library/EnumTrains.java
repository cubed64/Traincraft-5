...
public enum EnumTrains implements ITrainRecord
{
	...
	RS2("RS2", DieselRS2.class, ItemIDs.minecartRS2.item, "diesel", 1500, 105, 0, 28, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "LightBlue", "White", "Magenta", "Brown", "Skin19", "Skin20", "Black"}), 16, -2.5),
