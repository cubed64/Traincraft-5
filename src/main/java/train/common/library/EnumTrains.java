...
public enum EnumTrains {
	...
	GP30("GP30", DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 134, 0, 30, 0, 200, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Black", "Blue", "Skin23", "Skin24", "LightBlue", "Grey", "Skin17", "Yellow", "Green", "Skin18", "Skin16", "Purple", "Pink", "Red", "Skin19", "LightGrey", "Skin20", "Skin21", "Skin22", "Magenta"}), 15, -2.9),
