...
public enum EnumTrains {
	...
	ACF4650("ACF4650", ACF4650.class, ItemIDs.minecartACF4650.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Skin18", "Grey", "LightGrey", "Skin16", "Skin17", "Brown", "White", "Skin19", "Blue", "Orange", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	GSC53FootFlatcar("GSC_53Flatcar", GSC53FootFlat.class, ItemIDs.minecartGSC53FootFlatcar.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Brown", "Green", "Lime", "Black", "White", "Grey", "LightGrey"}), 12, 45, (new String[] {"Cargo: whatever flatcars carry i guess"})),
	GSC53Foot6_6Bulkhead("GSC_53_66Bulkhead", GSC53Foot66Bulkhead.class, ItemIDs.minecartGSC5366FootBulkhead.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Red", "Black", "Grey"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
	GSC53Foot8_6Bulkhead("GSC_53_86Bulkhead", GSC53Foot86Bulkhead.class, ItemIDs.minecartGSC5386FootBulkhead.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Red", "Purple", "Black", "Lime", "White", "Grey"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),

	PS140("PS140",  PS140.class, ItemIDs.minecartPS140.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "LightBlue", "Green", "Cyan", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Yellow", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Magenta"}), 15, 27, (new String[] {"Cargo: Any."})),
	...
	NSCReefer("NSCReefer",  NSCReefer.class, ItemIDs.minecartNSCchildHUH.item, "freight", 2.75, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "LightGrey", "Orange"}), 16, 36, (new String[] {"Cargo: meet and HUH!?"})),
	PCF6033("PCF6033", PCF6033.class, ItemIDs.minecartPCF6033.item, "freight", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Skin16", "Pink", "Blue", "Red", "Skin17", "Yellow", "Magenta", "Cyan", "Skin18", "Skin19", "LightGrey", "Skin20", "Skin21", "Skin22"}), 10, 54, (new String[] {"Cargo: Any."})),
	ACFRailbox("ACF Railbox", ACFRailbox.class, ItemIDs.minecartACFRailbox.item, "freight", 4, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Blue", "Black", "Orange", "Pink", "LightBlue", "White", "Magenta", "Cyan", "Grey"}), 12, 54, (new String[] {"Cargo: Any."})),
	ACFRailboxCushioned("ACF Railbox (Cushioned)", ACFRailboxCushioned.class, ItemIDs.minecartACFRailboxCushioned.item, "freight", 4, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "White", "Brown", "Red", "Blue", "Grey", "Orange"}), 12, 54, (new String[] {"Cargo: Any."})),
	...
	WoodchipHopper("Woodchip Hopper", WoodchipHopper.class, ItemIDs.minecartWoodchipHopper.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Blue", "Green", "Orange", "Red", "White", "Cyan", "Skin18", "Skin19", "Skin16", "Skin17"}), 14, 45, (new String[] {"Cargo: Woodchips/Sawdust."})),
	...
	gsco52millgon("52millgon", gsco52millgon.class, ItemIDs.minecart52millgon.item, "freight", 3.0, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "Red", "Skin16", "Black", "Grey", "Purple", "Brown", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21"}), 12, 45, (new String[] {"Cargo: Any."})),
	...
	DOT11117600( "DOT17600", DOT11117600.class, ItemIDs.minecart17600DOT111.item, "tank", 0, 0, 2.5, 0, 0, 0, 0, 0, 67000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Blue", "LightGrey", "Grey", "Yellow", "Brown", "Purple", "Skin16", "Skin17", "Skin18"}), 16, 0, (new String[] {"Capacity: 67000mb."})),
