...
public enum EnumTrains {
	...
	SDP40("SDP40", DieselSDP40.class, ItemIDs.minecartSDP40.item, "diesel", 3000, 160, 0, 5, 0, 200, 0.75, 0.85, 14000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Skin16", "Skin17", "Grey", "LightGrey", "Skin18", "Purple", "Blue", "Orange"}), 12, -3.45),
	...
	ACF4650("ACF4650", ACF4650.class, ItemIDs.minecartACF4650.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Skin18", "Grey", "LightGrey", "Skin16", "Skin17", "Brown", "White", "Skin19", "Blue", "Orange", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26"}), 15, 36,(new String[] {"Cargo: Any."})),
	PS2_4750("PS2_4750", PS2_4750.class, ItemIDs.minecartPS2_4750.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "White", "Skin17", "Skin18", "Skin16", "Skin20", "Grey", "Skin19", "LightBlue", "Skin21", "Yellow", "Skin22", "Orange", "Magenta", "Green", "Lime", "Purple", "Skin23", "Cyan", "Brown", "Pink", "Skin24", "Skin25", "Skin28", "Skin27", "Skin29"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	FNCC60FootBulk("FNCC60FootBulk", FNCC60FootBulk.class, ItemIDs.minecartFNCC60FootBulk.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Green", "Yellow", "Skin16", "Skin17", "Lime", "Skin18", "Skin19", "Skin20", "Skin21"}), 12, 45, (new String[] {"Cargo: Bulkhead Stuff."})),
	...
	gsco67millgon("67millgon", gsco67millgon.class, ItemIDs.minecart67millgon.item, "freight", 3.5, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Green", "Brown", "Blue", "Grey", "Skin16", "Skin17"}), 12, 45, (new String[] {"Cargo: Any."})),
