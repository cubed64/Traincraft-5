...
public enum EnumTrains {
	...
	FP7A("FP7A", DieselFP7A.class, ItemIDs.minecartFP7A.item, "diesel", 1500, 192, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "LightGrey", "Skin16", "Orange", "Skin17", "Cyan"}), 16, -2.70),
	...
	B23S7("B23-S7", DieselB23S7.class, ItemIDs.minecartB23S7.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Grey", "Skin17", "LightGrey", "Cyan"}), 14, -3.1),
	...
	PCF6033("PCF6033", PCF6033.class, ItemIDs.minecartPCF6033.item, "freight", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Skin16", "Pink", "Blue", "Red", "Skin17", "Yellow", "Magenta", "Cyan", "Skin18", "Skin19", "LightGrey", "Skin20", "Skin21"}), 10, 54, (new String[] {"Cargo: Any."})),
