...
public enum EnumTrains {
	...
	GP30("GP30", DieselGP30.class, ItemIDs.minecartGP30.item, "diesel", 2250, 134, 0, 30, 0, 200, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Black", "Blue", "LightBlue", "Grey", "Skin17", "Yellow", "Green", "Skin18", "Cyan", "Skin16", "Purple", "Pink", "Red", "Skin19", "LightGrey", "Skin20"}), 15, -2.9),
	...
	U18BWH("U18BWH", DieselU18BWH.class, ItemIDs.minecartU18BWH.item, "diesel", 1800, 188, 0, 25, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Pink", "LightGrey"}), 14, -3.1),
	...
	Dash840B("Dash840B", DieselDash840B.class, ItemIDs.minecartDash840B.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Yellow", "Orange", "LightBlue", "Pink"}), 12, -3.6),
	...
	Dash840BW("Dash840BW", DieselDash840BW.class, ItemIDs.minecartDash840BW.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Orange", "LightGrey"}), 12, -3.6),
	...
	Dash841C("Dash841C", DieselDash841C.class, ItemIDs.minecartDash841C.item, "diesel", 4100, 113, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "LightGrey", "Pink", "Orange", "Skin16", "Green", "Skin17"}), 12, -4.0),
	...
	SBMS("SBMS", SBMS.class, ItemIDs.minecartSBMS.item, "slug", 0, 0, 7, 0, 0, 0, 0, 0, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "LightGrey", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26"}), 12, 0, (new String[] {"Reduces train weight when fueled"})),
	...
	pch120coach("PCH-120 Commute Car", PCH120Coach.class, ItemIDs.minecartPCH120Car.item, "passenger",0, 0, 2, 0, 0, 0, 0, 0, 0,TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Red", "Green", "Lime", "Purple"}), 14, 0),
	...
	HBC1C("HBC1C",HBC1Cboose.class, ItemIDs.minecartHBC1Ccaboose.item, "caboose", 2, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "White", "LightGrey", "Red", "Purple"}), 16, 0, null),
	...
	Class74("Class74",ElectricClass74.class, ItemIDs.minecartClass74.item, "electric", 2426, 140, 0, 50, 0, 10, 0.6, 0.7, 13, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Purple"}), 10, -2),
