...
public enum EnumTrains implements IEnumTrains
{
	...
	AAR70TonHopper("AAR 70 Ton Hopper", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.AAR70TonHopper.class, ItemIDs.minecartAAR70TonHopper.item, "Open Top Hopper", 2, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Magenta", "Skin16"}), 16, 27, (new String[] {"Cargo: Ores."})),
	...
	DOT11111000( "DOT11000", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11111000.class, ItemIDs.minecart11000DOT111.item, "Tankcar", 0, 0, 2.25, 0, 0, 0, 0, 0, 41000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "LightGrey", "Grey"}), 16, 0, (new String[] {"Capacity: 41000mb."})),
	DOT11120600( "DOT20600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11120600.class, ItemIDs.minecart20600DOT111.item, "Tankcar", 0, 0, 3, 0, 0, 0, 0, 0, 78000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Black", "White", "Green", "LightGrey"}), 14, 0, (new String[] {"Capacity: 78000mb."})),
	DOT11129080( "DOT29080", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11129080.class, ItemIDs.minecart29080DOT111.item, "Tankcar", 0, 0, 3.25, 0, 0, 0, 0, 0, 110000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Orange", "LightGrey", "White", "Grey", "Skin16", "Skin17", "Skin18"}), 12, 0, (new String[] {"Capacity: 110000mb."})),
	DOT11117600( "DOT17600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DOT11117600.class, ItemIDs.minecart17600DOT111.item, "Tankcar", 0, 0, 2.5, 0, 0, 0, 0, 0, 67000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Black", "Blue", "LightGrey", "Grey", "Yellow", "Brown", "Purple", "Skin16", "Skin17", "Skin18"}), 16, 0, (new String[] {"Capacity: 67000mb."})),
	NATX30600( "NATX30600", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.NATX30600.class, ItemIDs.minecartNATX30600.item, "Tankcar", 0, 0, 3.25, 0, 0, 0, 0, 0, 116000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Grey", "Green", "Red", "Yellow", "Pink", "Skin16", "Skin17", "LightBlue", "Skin18"}), 12, 0, (new String[] {"Capacity: 116000mb."})),
	...
	DUPX39200( "DUPX39200", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.DUPX39200.class, ItemIDs.minecartDUPX39200.item, "Tankcar", 0, 0, 5, 0, 0, 0, 0, 0, 148000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "White", "Green", "Black"}), 10, 0, (new String[] {"Capacity: 148000mb."})),

	CoffinCar( "CoffinCar", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.tanker.CoffinCar.class, ItemIDs.minecartCoffinCar.item, "Tankcar", 0, 0, 1.5, 0, 0, 0, 0, 0, 16000, TraincraftUtil.getBytesFromColors(new String[] {"Black"}), 14, 0, (new String[] {"Capacity: 16000mb."})),
	...
	ACFGNRPO_30("AC&F GN RPO (30' mail)", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.freight.ACFGNRPO_30.class, ItemIDs.minecartACFGNRPO_30.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Yellow", "Green", "Lime"}), 10, 27,null),
	ACFGN60SeatCoach("AC&F GN 60 Seat Coach", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.ACFGN60SeatCoach.class, ItemIDs.minecartACFGN60SeatCoach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Orange", "Yellow", "Brown", "LightBlue", "Green", "LightGrey", "Black", "White", "Cyan", "Blue", "Lime", "Grey", "Skin16", "Skin17", "Skin18", "Skin19"}), 10, 0, null),
	...
	ICCBaywindowWP("ICCBaywindowWP", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.workcart.ICCBaywindowWP.class, ItemIDs.minecartICCBaywindowWP.item, "caboose", 2, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Red", "Skin16", "Green", "Cyan", "Skin17", "Orange", "Skin18", "Skin19", "Skin20", "Skin21"}), 16, 0, null),
	CA11("CA11", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.workcart.CA11.class, ItemIDs.minecartCA11.item, "caboose", 2, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Cyan", "Skin17", "Skin18", "Purple", "Skin19"}), 16, 0, null),
