...
public enum EnumTrains implements IEnumTrains
{
	...
	B30("B30-7", DieselB30.class, ItemIDs.minecartB30.item, "diesel", 3000, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin34", "Skin31"}), 14, -3.1),
