...
public enum EnumTrains {
	...
	R70Reefer("R70Reefer", R70Reefer.class, ItemIDs.minecartR70Reefer.item, "freight", 5, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "LightGrey", "Cyan"}), 10, 54, (new String[] {"Cargo: Any."})),
