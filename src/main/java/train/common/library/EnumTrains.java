...
public enum EnumTrains {
	...
	ACF4650("ACF4650", ACF4650.class, ItemIDs.minecartACF4650.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"Green", "Lime", "Skin18", "Grey", "LightGrey", "Skin16", "Skin17", "Brown", "White", "Skin19", "Blue", "Orange", "Skin20", "Skin21", "Skin22"}), 15, 36,(new String[] {"Cargo: Any."})),
	PS2_4750("PS2_4750", PS2_4750.class, ItemIDs.minecartPS2_4750.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "White", "Skin17", "Skin18", "Skin16", "Skin20", "Grey", "Skin19", "LightBlue", "Skin21", "Yellow", "Skin22", "Orange", "Magenta", "Green", "Lime", "Purple", "Skin23"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	PCF6033("PCF6033", PCF6033.class, ItemIDs.minecartPCF6033.item, "freight", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Skin16", "Pink", "Blue", "Red", "Skin17", "Yellow", "Magenta", "Cyan", "Skin18", "Skin19", "LightGrey"}), 10, 54, (new String[] {"Cargo: Any."})),
