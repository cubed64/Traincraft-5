...
public enum EnumTrains {
	...
	GP15("GP15", DieselGP15.class, ItemIDs.minecartGP15.item, "diesel", 1500, 105, 0, 15, 0, 200, 0.85, 0.85, 15000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow", "LightGrey", "Cyan", "LightBlue", "Skin26", "Skin16", "Blue"}), 16, -2.6),
	...
	SD60("SD60", DieselSD60.class, ItemIDs.minecartSD60.item, "diesel", 3800, 113, 0, 20, 0, 200, 0.75, 0.85, 23000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "Skin16", "Red", "Yellow", "Brown", "LightBlue", "LightGrey", "Purple", "Green", "Lime"}), 12, -3.725),
	...
	U18BW("U18BW", DieselU18BW.class, ItemIDs.minecartU18BW.item, "diesel", 1800, 120, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "White", "Orange", "Grey", "Lime", "Skin27"}), 16, -2.5),
	U18Balt("U18Balt", DieselU18Balt.class, ItemIDs.minecartU18Balt.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Cyan", "White", "LightGrey", "Skin16", "Skin17", "Skin18", "Lime", "Skin19"}), 16, -2.6),
	...
	BQ23("BQ23-7", DieselBQ23.class, ItemIDs.minecartBQ23.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Red", "Skin17", "Cyan", "LightGrey", "Skin18", "LightBlue", "Pink", "Skin16"}), 14, -3.1),
	...
	RS1("RS1", DieselRS1.class, ItemIDs.minecartRS1.item, "diesel", 1000, 105, 0, 30, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Blue", "Green", "LightGrey", "Skin17", "Skin18", "Cyan", "LightBlue", "Purple", "Skin19"}), 16, -2.5),
	...
	S12("S12", DieselS12.class, ItemIDs.minecartS12.item, "diesel", 1200, 97, 0, 35, 0, 180, 0.75, 0.7, 8000, TraincraftUtil.getBytesFromColors(new String[] {"Blue", "LightGrey", "Brown", "Skin16", "White", "Cyan", "Skin17", "Skin18", "Black"}), 16, -2.2),
	...
	PS2_4750("PS2_4750", PS2_4750.class, ItemIDs.minecartPS2_4750.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "White", "Skin17", "Skin18", "Skin16", "Skin20", "Grey", "Skin19", "LightBlue", "Skin21", "Yellow", "Skin22", "Orange", "Magenta", "Green", "Lime", "Purple", "Skin23", "Cyan", "Brown", "Pink", "Skin24", "Skin25", "Skin28", "Skin27", "Skin29", "Skin30", "Skin31", "Skin32", "Skin33", "Black", "Skin34", "Blue", "Skin35", "Skin36", "Skin37", "Skin38", "Skin39", "Skin40"}), 15, 36,(new String[] {"Cargo: Any."})),
	GATC4180Airslide("GATC4180Airslide", GATC4180Airslide.class, ItemIDs.minecartGATC4180Airslide.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Grey", "Skin17", "LightGrey", "Skin18", "Skin21", "Skin19", "Green", "Orange", "Yellow", "Skin20", "Pink", "Magenta", "Skin22", "Skin23"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	GSC53Foot6_6Bulkhead("GSC_53_66Bulkhead", GSC53Foot66Bulkhead.class, ItemIDs.minecartGSC5366FootBulkhead.item, "Bulkhead Flat", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Red", "Black", "Grey"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
	...
	R70Reefer2("R70Reefer2", R70Reefer2.class, ItemIDs.minecartR70Reefer2.item, "Refrigerated Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
