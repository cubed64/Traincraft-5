...
public enum EnumTrains {
	...
	GATC4180Airslide("GATC4180Airslide", GATC4180Airslide.class, ItemIDs.minecartGATC4180Airslide.item, "Covered Hopper", 3, TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Grey", "Skin17", "LightGrey", "Skin18", "Skin21", "Skin19", "Green", "Orange", "Yellow", "Skin20", "Pink", "Magenta", "Skin22", "Skin23", "Skin24"}), 15, 36,(new String[] {"Cargo: Any."})),
	...
	R70Reefer2("R70Reefer2", R70Reefer2.class, ItemIDs.minecartR70Reefer2.item, "Refrigerated Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "White"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
