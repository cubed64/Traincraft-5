...
public enum EnumTrains {
	...
	Dash840C("Dash840C", DieselDash840C.class, ItemIDs.minecartDash840C.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.8, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Orange", "Yellow", "Black", "Grey", "Red", "LightGrey", "Green", "Blue"}), 12, -4),
	Dash841C("Dash841C", DieselDash841C.class, ItemIDs.minecartDash841C.item, "diesel", 4100, 113, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red"}), 12, -4.0),
	...
	AC4400C("AC4400C", DieselAC4400C.class, ItemIDs.minecartAC4400C.item, "diesel", 4400, 119, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Cyan", "LightBlue", "Grey"}), 12, -4.0),
	...
	ACF2Bay("ACF2Bay", ACF2Bay.class, ItemIDs.minecartACF2Bay.item, "freight", 2.5, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "Black", "Magenta", "Skin16"}), 15, 27,(new String[] {"Cargo: Any."})),
	...
	R70Reefer("R70Reefer", R70Reefer.class, ItemIDs.minecartR70Reefer.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "LightGrey", "Cyan", "White", "Yellow", "Skin16", "Orange", "Skin17", "Skin18", "Green", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
