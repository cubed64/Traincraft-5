...
public enum EnumTrains implements IEnumTrains
{
	...
	GP40Dash2("GP40Dash2", DieselGP40Dash2.class, ItemIDs.minecartGP40Dash2.item, "diesel", 3000, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Skin31", "Skin16", "Skin17", "Skin27", "Lime", "White", "Skin18", "Blue", "LightGrey", "Black", "Skin26", "Skin29", "Grey"}), 14, -2.9),
	...
	U30C("U30C", DieselU30C.class, ItemIDs.minecartU30C.item, "diesel", 3000, 113, 0, 20, 0, 200, 0.7, 0.88, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "LightGrey", "Cyan", "Grey", "Skin17", "Skin18", "Lime", "Orange", "Skin19", "Skin20", "Yellow", "Skin21", "Skin22", "Skin23", }), 12, -3.3),
	...
	B30("B30-7", DieselB30.class, ItemIDs.minecartB30.item, "diesel", 3000, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin34", "Skin31", "Blue", "Skin38", "Skin36", "Skin35", "Skin37"}), 14, -3.1),
	B36("B36-7", DieselB36.class, ItemIDs.minecartB36.item, "diesel", 3600, 113, 0, 20, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin30", "Skin31", "Skin40", "Skin38", "Skin41", "Skin36", "Skin39"}), 14, -3.1),
	...
	Dash839C("Dash839C", DieselDash839C.class, ItemIDs.minecartDash839C.item, "diesel", 3900, 120, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "Skin19", "Black", "Blue", "Skin17", "Cyan", "LightGrey", "Skin16", "Brown", "Orange", "Skin18"}), 12, -4.0),
	...
	Dash840B("Dash840B", DieselDash840B.class, ItemIDs.minecartDash840B.item, "diesel", 4000, 113, 0, 40, 0, 200, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Blue", "Yellow", "Orange", "LightBlue", "Pink", "Purple"}), 12, -3.6),
	...
	RS3("RS3", DieselRS3.class, ItemIDs.minecartRS3.item, "diesel", 1600, 137, 0, 28, 0, 200, 0.7, 0.8, 8000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "LightGrey", "Yellow", "Magenta", "Skin19", "Skin20", "Skin21", "Skin22"}), 16, -2.5),
