...
public enum EnumTrains {
	...
	GPFDL("GPFDL", DieselGPFDL.class, ItemIDs.minecartGPFDL.item, "diesel", 2250, 105, 0, 25, 0, 200, 0.80, 0.85, 18000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan","LightGrey", "Skin16"}), 16, -2.9),
	...
	U18BWH("U18BWH", DieselU18BWH.class, ItemIDs.minecartU18BWH.item, "diesel", 2250, 188, 0, 25, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Pink", "LightGrey"}), 14, -3.1),
	...
	U36C("U36C", DieselU36C.class, ItemIDs.minecartU36C.item, "diesel", 3600, 113, 0, 20, 0, 200, 0.75, 0.84, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Grey", "Blue", "Red", "Yellow", "Orange"}), 12, -3.75),
	U50("U50", DieselU50.class, ItemIDs.minecartU50.item, "diesel", 5000, 110, 0, 10, 0, 200, 0.8, 0.85, 15000, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Red", "Cyan", "LightGrey", "Skin16", "Skin17", "Black"}), 10, -4.35),
	...
	Dash841C("Dash841C", DieselDash841C.class, ItemIDs.minecartDash841C.item, "diesel", 4100, 113, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "LightGrey", "Pink", "Orange", "Skin16", "Green"}), 12, -4.0),
	...
	GM6C("GM6C",ElectricGM6C_2.class, ItemIDs.minecartGM6C.item, "electric", 6000, 115, 0, 55, 0, 200, 0.65, 0.79, 12500, TraincraftUtil.getBytesFromColors(new String[] {"White", "LightGrey", "LightBlue", "Black", "Skin17", "Cyan"}), 12, -3.45),
