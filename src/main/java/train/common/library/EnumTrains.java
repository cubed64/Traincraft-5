...
public enum EnumTrains implements ITrainRecord
{
	...
	HCS_c57("HCS_c57", SteamHCS_c57.class, ItemIDs.minecartHCS_c57.item, "steam", 1753, 85, 0, 75, 75, 190, 0.85, 0.8, 2000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Cyan"}), 14, -2.20),
	...
	HotTubTender("HotTubTender", HotTubTender.class, ItemIDs.minecartHotTubTender.item,"tender",0,0,3,0,0,0,0,0,41000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Skin16", "Skin17"}),18,0, (new String[] {"Water capacity: 41001mb."})),
	...
	F3B("F3B", DieselF3B.class, ItemIDs.minecartF3B.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Skin31", "Skin17", "Black", "Yellow", "Grey", "Orange", "LightBlue", "Lime", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26"}), 18, -2.4),
	F7A("F7A", DieselF7A.class, ItemIDs.minecartF7A.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin17", "Magenta", "Yellow", "Grey", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Skin30", "Skin31", "Skin32", "Skin33", "Red", "Pink", "LightGrey", "White", "Skin34"}), 18, -2.6),
	F7B("F7B", DieselF7B.class, ItemIDs.minecartF7B.item, "diesel", 1500, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Skin17", "Magenta", "Yellow", "Grey", "Orange", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26", "Skin27", "Skin28", "Skin29", "Red", "LightGrey", "Skin34"}), 18, -2.4),
	F9A("F9A", DieselF9A.class, ItemIDs.minecartF9A.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Cyan", "Brown", "Black", "Yellow", "Grey", "Orange"}), 18, -2.6),
	F9B("F9B", DieselF9B.class, ItemIDs.minecartF9B.item, "diesel", 1750, 133, 0, 25, 0, 200, 0.9, 0.85, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Cyan", "Yellow", "Grey", "Orange"}), 18, -2.4),
	...
	B30("B30-7", DieselB30.class, ItemIDs.minecartB30.item, "diesel", 3000, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Skin29", "Skin34", "Skin31", "Blue", "Skin38", "Skin36", "Skin35", "Skin37", "Skin42" }), 14, -3.1),
	...
	PSCNWRPO60("PS CNW RPO(60')", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.rpo.PSCNWRPO60.class, ItemIDs.minecartPSCNWRPO60.item, "freight", 1.5, TraincraftUtil.getBytesFromColors(new String[]{"Yellow", "Green", "Orange", "Red", "Grey", "LightGrey", "Grey", "White", "Magenta", "Brown", "Lime"}), 10, 27,null),
	...
	MILW1935Baggage_Dinette("MILW 1935 Baggage-Dinette", com.jcirmodelsquad.tcjcir.vehicles.rollingstock.passenger.combinecar.MILW1935Baggage_Dinette.class, ItemIDs.minecartMILW1935Baggage_Dinette.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[]{"Black"}), 12, 0, 27,null),
	...
	TwoBil("TwoBil",ElectricTwoBil.class, ItemIDs.minecartTwoBil.item, "electric", 428, 121, 0, 7, 0, 0, 0.5, 0.9, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey"}), 11, -3.4, (new String[] {"Not BAP, but gets to be included"})),
	...
	FourCor("FourCor",ElectricFourCor.class, ItemIDs.minecartFourCor.item, "electric", 900, 121, 0, 7, 0, 0, 0.5, 0.9, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey"}), 11, -3.4, (new String[] {"Not BAP, but gets to be included"})),
	FourCorTrailerComposite("FourCorTrailerComposite", PassengerFourCorTrailerComposite.class, ItemIDs.minecartFourCorTrailerComposite.item, "passenger", 0, 0, 16, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Purple", "LightGrey", "Grey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
	FourCorTrailerSecond("FourCorTrailerSecond", PassengerFourCorTrailerSecond.class, ItemIDs.minecartFourCorTrailerSecond.item, "passenger", 0, 0, 16, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Purple", "LightGrey", "Grey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
	FourBuf("FourBuf", PassengerFourBuf.class, ItemIDs.minecartFourBuf.item, "passenger", 0, 0, 17, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Purple", "LightGrey", "Grey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
	FourCorTail("FourCorTail", PassengerFourCorTail.class, ItemIDs.minecartFourCorTail.item, "passenger", 0, 0, 18, 0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGrey", "Grey"}), 11, 0, (new String[] {"Not BAP, but gets to be included"})),
