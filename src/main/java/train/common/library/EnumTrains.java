...
public enum EnumTrains {
	...
	BQ23("BQ23-7", DieselBQ23.class, ItemIDs.minecartBQ23.item, "diesel", 2250, 113, 0, 25, 0, 200, 0.74, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Red", "Skin17", "Cyan"}), 10, -3.1),
