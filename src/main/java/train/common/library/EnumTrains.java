...
public enum EnumTrains {
	...
	U30BH("U30BH", DieselU30BH.class, ItemIDs.minecartU30BH.item, "diesel", 2950, 188, 0, 35, 0, 180, 0.8, 0.91, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "LightGrey"}), 14, -3.1),
	...
	TB27("TB27",DieselTB27.class, ItemIDs.minecartTB27.item, "diesel", 2700, 110, 0, 40, 0, 200, 0.7, 0.8, 18000, TraincraftUtil.getBytesFromColors(new String[]{"Red", "LightGrey", "White"}), 14, -2.8),
	...
	CA11("CA11",CA11.class, ItemIDs.minecartCA11.item, "caboose", 2, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Cyan", "Skin17"}), 16, 0, null),
