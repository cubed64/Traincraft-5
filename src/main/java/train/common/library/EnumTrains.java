...
public enum EnumTrains {
	...
	U23BU("U23BU", DieselU23BU.class, ItemIDs.minecartU23BU.item, "diesel", 2250, 113, 0, 30, 0, 160, 0.75, 0.86, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Skin17", "Skin29", "Skin19", "Skin16", "Black", "LightGrey", "Skin20", "Skin21", "Skin18", "Skin22"}), 14, -3.1),
