...
public enum EnumTrains {
	...
	PS2_4750("PS2_4750", PS2_4750.class, ItemIDs.minecartPS2_4750.item, "freight", 3, TraincraftUtil.getBytesFromColors(new String[]{"LightGrey", "White", "Skin17", "Skin18", "Skin16"}), 15, 36,(new String[] {"Cargo: Any."})),
