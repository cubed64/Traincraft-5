...
public enum EnumTrains {
	...
	GP38("GP38", DieselGP38.class, ItemIDs.minecartGP38.item, "diesel", 2300, 105, 0, 25, 0, 200, 0.8, 0.85, 20000, TraincraftUtil.getBytesFromColors(new  String[] {"Yellow","Grey", "Green", "Skin16", "Cyan", "LightGrey", "Skin18", "Blue", "Black", "Skin17", "Skin19", "Skin20","Skin21", "Skin22", "Skin23", "Skin24", "Magenta", "Orange", "Skin25"}), 14, -2.9),
	...
	U23B("U23B", DieselU23B.class, ItemIDs.minecartU23B.item, "diesel", 2250, 113, 0, 25, 0, 180, 0.7, 0.88, 20000, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Grey", "Cyan", "LightBlue", "LightGrey", "Skin17", "Skin21", "Skin22", "Blue", "Skin25", "Magenta", "Black", "Pink", "Green", "Skin18", "Skin20", "Skin23", "Skin24", "Skin26", "Skin27", "Skin28", "Orange"}), 14, -3.1),
	...
	SB18R("SB18R", DieselSB18R.class, ItemIDs.minecartSB18R.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey"}), 16, -2.6),
	SB18E("SB18E", DieselSB18E.class, ItemIDs.minecartSB18E.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey"}), 16, -2.6),
	SB18B("SB18B", DieselSB18B.class, ItemIDs.minecartSB18B.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey"}), 16, -2.6),
	...
	Dash839C("Dash839C", DieselDash839C.class, ItemIDs.minecartDash839C.item, "diesel", 3900, 120, 0, 45, 0, 180, 0.8, 0.87, 20000, TraincraftUtil.getBytesFromColors(new String[] {"LightBlue", "Grey", "Black", "Blue", "Cyan", "LightGrey", "Skin16", "Brown", "Orange"}), 12, -4.0),
	...
	OWO60Verticube("OWO 60 Verticube", OWO60Verticube.class, ItemIDs.minecartOWO60Verticube.item, "freight", 3.75, TraincraftUtil.getBytesFromColors(new String[] {"Cyan", "Lime", "Green", "Brown", "White", "Pink", "Purple", "Skin16", "Skin17"}), 10, 54, (new String[] {"Cargo: Any."})),
	...
	Hicube60("60 Foot Hi-Cube Boxcar", Hicube60foot.class, ItemIDs.minecarthicube60foot.item, "freight", 4, TraincraftUtil.getBytesFromColors(new String[] {"Yellow", "Red", "Pink", "Blue", "Skin16", "Skin17", "Lime", "White", "Cyan", "Green", "Purple"}), 12, 54, (new String[] {"Cargo: Any."})),
