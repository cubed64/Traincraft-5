...
public enum EnumTrains {
	...
	SD70ACe("SD70ACe", DieselSD70ACe.class, ItemIDs.minecartSD70ACe.item, "diesel", 4300, 110, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Blue", "LightBlue", "Skin17" }), 12, -4.0),
	SD70ACe_H("SD70ACe_H", DieselSD70ACe_H.class, ItemIDs.minecartSD70ACe_H.item, "diesel", 4300, 110, 0, 45, 0, 180, 0.8, 0.87, 21000, TraincraftUtil.getBytesFromColors(new String[] {"Skin16"}), 12, -4.0),
	...
	GSC53Foot8_6Bulkhead("GSC_53_86Bulkhead", GSC53Foot86Bulkhead.class, ItemIDs.minecartGSC5386FootBulkhead.item, "Bulkhead Flat", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Green", "Red", "Purple", "Black", "Lime", "White", "Grey"}), 12, 45, (new String[] {"Cargo: Bulkhead Items."})),
	...
	ACFRailboxCushioned("ACF Railbox (Cushioned)", ACFRailboxCushioned.class, ItemIDs.minecartACFRailboxCushioned.item, "Boxcar", 4, TraincraftUtil.getBytesFromColors(new String[] {"Green", "Lime", "White", "Brown", "Red", "Blue", "Grey", "Orange"}), 12, 54, (new String[] {"Cargo: Any."})),
