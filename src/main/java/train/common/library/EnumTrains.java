...
public enum EnumTrains {
	...
	R70Reefer2("R70Reefer2", R70Reefer2.class, ItemIDs.minecartR70Reefer2.item, "Refrigerated Boxcar", 3, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "White", "Orange", "Skin19", "Yellow"}), 10, 54, (new String[] {"Cargo: Cold Stuff lol"})),
