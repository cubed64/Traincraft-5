...
public enum EnumTrains {
	...
	MaPa35FootFlatcar("MaPa_35Flatcar", MaPa35FootFlat.class, ItemIDs.minecartMaPa35FootFlatcar.item, "Flatcar", 2.5, TraincraftUtil.getBytesFromColors(new String[] {"Brown", "Magenta"}), 12, 18, (new String[] {"Cargo: whatever flatcars carry i guess"})),
