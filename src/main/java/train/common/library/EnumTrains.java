...
public enum EnumTrains {
	...
	SB18R("SB18R", DieselSB18R.class, ItemIDs.minecartSB18R.item, "diesel", 1800, 113, 0, 30, 0, 200, 0.7, 0.88, 10000, TraincraftUtil.getBytesFromColors(new String[] {"LightGrey", "Grey", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25"}), 16, -2.6),
