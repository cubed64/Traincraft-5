...
public class DieselGP40 extends DieselTrain {
    public DieselGP40(World world) {
        ...
        textureDescriptionMap.put(4, "Western Pacific 1776");
        textureDescriptionMap.put(5, "Western Pacific");
        textureDescriptionMap.put(6, "are there any more Western Pacifics i should know about");
        textureDescriptionMap.put(7, "Burlington Northern");
        textureDescriptionMap.put(8, "Chicago, Burlington & Quincy");
        textureDescriptionMap.put(9, "Suffern Hoboken Interstate Transfer");
        textureDescriptionMap.put(10, "Deadwood & La Mesa");
        textureDescriptionMap.put(11, "New York Central");
        textureDescriptionMap.put(12, "New York Central");
        textureDescriptionMap.put(13, "Great Lakes & Northern Territories");
        textureDescriptionMap.put(14, "DRGW (small logo)");
        textureDescriptionMap.put(15, "Western Maryland");
        textureDescriptionMap.put(16, "Milwaukee Road");
        textureDescriptionMap.put(17, "Milwaukee Road (Billboard)");
        textureDescriptionMap.put(18, "North Fox (Kit-80, Big Canon)");
