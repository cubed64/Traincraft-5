...
public class DieselCF7angle extends DieselTrain {
    public DieselCF7angle(World world) {
        ...
        textureDescriptionMap.put(3, "Columbus & Greenville Railway");
        textureDescriptionMap.put(4, "Red River Valley & Western");
        textureDescriptionMap.put(5, "Twin Cities & Western");
        textureDescriptionMap.put(6, "Los Angeles Junction");
        textureDescriptionMap.put(7, "WATCO 6");
        textureDescriptionMap.put(8, "WATCO 7");
        textureDescriptionMap.put(9, "WATX 1002");
        textureDescriptionMap.put(10, "WAMX 7108");
        textureDescriptionMap.put(11, "WATX 2633");
        textureDescriptionMap.put(12, "Grafton & Upton");
        textureDescriptionMap.put(13, "Delta Southern");
        textureDescriptionMap.put(14, "Midwest Coal Handling");
        textureDescriptionMap.put(15, "Mississippi & Skuna Valley D-5");
        textureDescriptionMap.put(16, "Gloster Southern");
        textureDescriptionMap.put(17, "Amtrak 585");
        textureDescriptionMap.put(18, "Nittany & Blad Eagle");
        textureDescriptionMap.put(19, "Florida Central 50");
