...
public class DieselRSFDL extends DieselTrain {
    public DieselRSFDL(World world) {
        ...
        initLoco();
        textureDescriptionMap.put(0, "FNCC (MW-S, Big Canon)");
        textureDescriptionMap.put(1, "FNCC 9919, (Regal, Big Canon)");
    ...
    public void updateRiderPosition() {
        ...
        double distance = 2.1; //how far forward/backwards on the entity you ride; forward > 0; backwards < 0;
