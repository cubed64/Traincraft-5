...
public class DieselWorkdayHyrail extends DieselTrain {
    ...
    public void updateRiderPosition() {
        ...
        double distance = 1.3; //how far forward/backwards on the entity you ride; forward > 0; backwards < 0;
        double distanceLR = 0.30; //how far left/right on the entity you ride; left > 0; right < 0;
        double yOffset = -0.4;
