...
public class DieselGP40Dash2 extends DieselTrain {
    public DieselGP40Dash2(World world) {
        ...
        initLoco();
        textureDescriptionMap.put(0, "Florida East Coast");
        textureDescriptionMap.put(1, "Paradox Rail");
        textureDescriptionMap.put(2, "Western Pacific");
        textureDescriptionMap.put(3, "Western Pacific");
        textureDescriptionMap.put(4, "Morristown Tenneva & Southern");
        textureDescriptionMap.put(5, "Avanste Northeastern");
        textureDescriptionMap.put(6, "Avanste Northeastern (Snow Service)");
        textureDescriptionMap.put(7, "Amtrak (PH III)");
        textureDescriptionMap.put(8, "Norfolk Southern");
        textureDescriptionMap.put(9, "Athearn RTR GP40 (Avanste Northeastern)");
        textureDescriptionMap.put(10, "DRGW (big logo)");
    ...
    public DieselGP40Dash2(World world, double d, double d1, double d2){
        this(world);
