...
public class DieselGP30 extends DieselTrain {
    public DieselGP30(World world) {
        ...
        textureDescriptionMap.put(3, "CSX (YN2)");
        textureDescriptionMap.put(4, "CSX (MoW)");
        textureDescriptionMap.put(5, "CR");
        textureDescriptionMap.put(6, "DRGW (Small Logo)");
        textureDescriptionMap.put(7, "ARR (Rebuilt)");
        textureDescriptionMap.put(8, "UP");
        textureDescriptionMap.put(9, "BN 2206");
        textureDescriptionMap.put(10, "BN 2222");
        textureDescriptionMap.put(11, "FNCC 250");
        textureDescriptionMap.put(12, "OC&G 35");
        textureDescriptionMap.put(13, "MAG 84");
        textureDescriptionMap.put(14, "KCS i mean CGW");
        textureDescriptionMap.put(15, "DLMR");
        textureDescriptionMap.put(16, "B&B");
        textureDescriptionMap.put(17, "WV");
        textureDescriptionMap.put(18, "GLNT");
        ...
        textureDescriptionMap.put(23, "Chessie System");
    }
