...
public class DieselGP38 extends DieselTrain {
    public DieselGP38(World world) {
        ...
        textureDescriptionMap.put(5, "ATSF (Pinstripe)");
        textureDescriptionMap.put(6, "ATSF (Freightbonnet)");
        textureDescriptionMap.put(7, "ATSF (Kodachrome)");
        textureDescriptionMap.put(8, "Penn Central");
