...
public class DieselCF7angle3 extends DieselTrain {
    public DieselCF7angle3(World world) {
        ...
        initLoco();
        InsertTexture(0, "ANE");
        InsertTexture(1, "FNCC (CEE Rebuilt)");
        InsertTexture(2, "FNCC (Ex CEE Ne WP)");
        InsertTexture(3, "FNCC 27");
        InsertTexture(4, "KCRC 2601 (FNCC 28)");
        InsertTexture(5, "KCRC 2583 (FNCC 29)");
        InsertTexture(6, "SNCT 102 (Post 1983)");
        InsertTexture(7, "SNCT 103 (Post 1983)");
        ...
        InsertTexture(16, "C&PV");
        InsertTexture(17, "CFW 1504");
        InsertTexture(18, "FURRX");
        InsertTexture(19, "GLNT");
        InsertTexture(20, "CNRC 4100 (Ex FNCC 41)");
        InsertTexture(21, "CNRC 4101-4102 (Ex ATSF)");
        InsertTexture(22, "");
        InsertTexture(23, "");
        InsertTexture(24, "");
        InsertTexture(25, "");
