...
public class ElectricPCC extends ElectricTrain {
	...
	public ElectricPCC(World world, double d, double d1, double d2) {
		this(world);
	...
	public void updateRiderPosition() {
		...
		double distance = 3.65; //how far forward/backwards on the entity you ride; forward > 0; backwards < 0;
