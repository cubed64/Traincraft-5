...
public class DieselU23B extends DieselTrain {
    public DieselU23B(World world) {
        ...
        InsertTexture(4, "Deep Rock Railroad");
        InsertTexture(5, "Deep Rock Railroad (C&PV Patch)");
        InsertTexture(6, "Carbondale & Pine Valley");
        ...
        InsertTexture(24, "Detroit Export System");
        InsertTexture(25, "Magnolia Properties");
        InsertTexture(26, "AGW");
        InsertTexture(27, "CNRC 5001 & 5002");
