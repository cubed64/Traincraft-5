...
public class BUnitE9B extends LiquidTank implements IFluidHandler {
	...
	public BUnitE9B(World world) {
		super(world, EnumTrains.E9B.getTankCapacity());
		initFreightWater();
		this.theTank = LiquidManager.getInstance().new FilteredTank(EnumTrains.E9B.getTankCapacity(), LiquidManager.dieselFilter());
	}

	public BUnitE9B(World world, double d, double d1, double d2) {
		this(world);
