...
public class DieselB23 extends DieselTrain {
    public DieselB23(World world) {
        ...
        textureDescriptionMap.put(6, "Western Pacific (Post 90s)");
        ...
        textureDescriptionMap.put(16, "Fox Union Rail Resources (FURRX)");
        textureDescriptionMap.put(17, "Camas Prairie Railnet");
        textureDescriptionMap.put(18, "Finger Lakes");
        textureDescriptionMap.put(19, "Finger Lakes (Ex Camas Prairie)");
        textureDescriptionMap.put(20, "AOK");
        textureDescriptionMap.put(21, "ADT (Ex UP)");
        textureDescriptionMap.put(22, "ADT (Ex NS)");
        ...
        textureDescriptionMap.put(27, "CNRC 1901 & 1903");
        textureDescriptionMap.put(28, "CNRC 1902");
        textureDescriptionMap.put(29, "CSXT (Stealth)");
        textureDescriptionMap.put(30, "CSXT (Bluedown)");
        textureDescriptionMap.put(31, "Seaboard");
    }
