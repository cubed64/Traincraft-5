...
public class DieselU23B extends DieselTrain {
    public DieselU23B(World world) {
        ...
        textureDescriptionMap.put(6, "Deep Rock Railroad (C&PV Patch)");
        textureDescriptionMap.put(7, "Carbondale & Pine Valley");
        textureDescriptionMap.put(8, "ATSF (Pinstripe)");
        textureDescriptionMap.put(9, "ATSF (Freightbonnet)");
        textureDescriptionMap.put(10, "Deleware & Hudson");
        textureDescriptionMap.put(11, "Southern");
        textureDescriptionMap.put(12, "MoPac");
        textureDescriptionMap.put(13, "Western Pacific");
        textureDescriptionMap.put(14, "Western Pacific");
        textureDescriptionMap.put(15, "Deadwood & La Mesa");
        textureDescriptionMap.put(16, "CSXT (YN2)");
        textureDescriptionMap.put(17, "Penn Central");
        ...
        textureDescriptionMap.put(27, "Suffern Hoboken Interstate Transfer 211");
        textureDescriptionMap.put(28, "Detroit Export System");
    }
