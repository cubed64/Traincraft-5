...
public class DieselU23B extends DieselTrain {
    public DieselU23B(World world) {
        ...
        textureDescriptionMap.put(6, "Conrail");
        textureDescriptionMap.put(7, "Blandsville & Blankerston");
        textureDescriptionMap.put(8, "Deep Rock Railroad");
        textureDescriptionMap.put(9, "Deep Rock Railroad (C&PV Patch)");
        textureDescriptionMap.put(10, "Carbondale & Pine Valley");
        textureDescriptionMap.put(11, "ATSF (Pinstripe)");
        textureDescriptionMap.put(12, "ATSF (Freightbonnet)");
        textureDescriptionMap.put(13, "Deleware & Hudson");
        textureDescriptionMap.put(14, "Southern");
        textureDescriptionMap.put(15, "MoPac");
        textureDescriptionMap.put(16, "Western Pacific");
        textureDescriptionMap.put(17, "Western Pacific");
        textureDescriptionMap.put(18, "Deadwood & La Mesa");
        textureDescriptionMap.put(19, "CSXT (YN2)");
        textureDescriptionMap.put(20, "Penn Central");
        textureDescriptionMap.put(21, "Seaboard System");
        textureDescriptionMap.put(22, "CFW 558");
        textureDescriptionMap.put(23, "Morristown Tenneva & Southern");
        textureDescriptionMap.put(24, "Milwaukee Road");
    }
