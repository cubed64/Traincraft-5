...
public class DieselU23B extends DieselTrain {
    public DieselU23B(World world) {
        ...
        textureDescriptionMap.put(4, "Deep Rock Railroad");
        textureDescriptionMap.put(5, "Deep Rock Railroad (C&PV Patch)");
        textureDescriptionMap.put(6, "Carbondale & Pine Valley");
        textureDescriptionMap.put(7, "ATSF (Pinstripe)");
        textureDescriptionMap.put(8, "ATSF (Freightbonnet)");
        textureDescriptionMap.put(9, "Deleware & Hudson");
        textureDescriptionMap.put(10, "Southern");
        textureDescriptionMap.put(11, "MoPac");
