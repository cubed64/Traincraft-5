...
public class BuddCBQDome50SeatCoach extends EntityRollingStock implements IPassenger {
	...
	public BuddCBQDome50SeatCoach(World world, double d, double d1, double d2) {
		this(world);
