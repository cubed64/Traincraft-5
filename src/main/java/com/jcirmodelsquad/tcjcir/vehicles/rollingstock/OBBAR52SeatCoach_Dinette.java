...
public class OBBAR52SeatCoach_Dinette extends EntityRollingStock implements IPassenger {
	...
	public OBBAR52SeatCoach_Dinette(World world, double d, double d1, double d2) {
		this(world);
