...
public class PSCEIRPO15_Baggage_38SeatCoach extends EntityRollingStock implements IPassenger {
	...
	public PSCEIRPO15_Baggage_38SeatCoach(World world, double d, double d1, double d2) {
		this(world);
