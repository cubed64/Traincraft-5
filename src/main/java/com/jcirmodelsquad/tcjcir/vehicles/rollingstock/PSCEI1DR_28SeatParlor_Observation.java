...
public class PSCEI1DR_28SeatParlor_Observation extends EntityRollingStock implements IPassenger {
	...
	public PSCEI1DR_28SeatParlor_Observation(World world, double d, double d1, double d2) {
		this(world);
