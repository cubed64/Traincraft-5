...
public class ModelRacor36H_off2 extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 32;

	public ModelRacor36H_off2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[29] = new ModelRendererTurbo(this, 12, 17, textureX, textureY); // Box 26 target b
		bodyModel[30] = new ModelRendererTurbo(this, 12, 9, textureX, textureY); // Box 47 target a
		...
		bodyModel[29].addShapeBox(-0.75F, 0F, -2.5F, 1, 2, 5, 0F,-0.5F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, -0.5F, 0F, 0.25F, -0.5F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, -0.5F, 0F, 0.25F); // Box 26 target b
		bodyModel[29].setRotationPoint(-1.5F, -19F, 0F);

		bodyModel[30].addShapeBox(-0.75F, 0F, -2.5F, 1, 2, 5, 0F,-0.5F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, -0.5F, 0F, 0.25F, -0.5F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, -0.5F, 0F, 0.25F); // Box 47 target a
		bodyModel[30].setRotationPoint(-1.5F, -19F, 0F);
