...
public class ModelHTCR2_new extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 64;

	public ModelHTCR2_new() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[6] = new ModelRendererTurbo(this, 13, 20, textureX, textureY); // Box 9 axle rear
		...
		bodyModel[20] = new ModelRendererTurbo(this, 1, 59, textureX, textureY); // Box 23
		bodyModel[21] = new ModelRendererTurbo(this, 9, 62, textureX, textureY); // Box 24
		bodyModel[22] = new ModelRendererTurbo(this, 11, 59, textureX, textureY); // Box 25
		...
		bodyModel[51] = new ModelRendererTurbo(this, 55, 22, textureX, textureY); // Box 69
		...
		bodyModel[66] = new ModelRendererTurbo(this, 40, 17, textureX, textureY); // Box 85
		bodyModel[67] = new ModelRendererTurbo(this, 38, 25, textureX, textureY); // Box 86
		bodyModel[68] = new ModelRendererTurbo(this, 36, 21, textureX, textureY); // Box 88
		bodyModel[69] = new ModelRendererTurbo(this, 44, 21, textureX, textureY); // Box 89
		bodyModel[70] = new ModelRendererTurbo(this, 58, 32, textureX, textureY); // Box 90
		bodyModel[71] = new ModelRendererTurbo(this, 58, 32, textureX, textureY); // Box 91
		bodyModel[72] = new ModelRendererTurbo(this, 49, 30, textureX, textureY); // Box 94
		...
		bodyModel[77] = new ModelRendererTurbo(this, 1, 59, textureX, textureY); // Box 100
		bodyModel[78] = new ModelRendererTurbo(this, 9, 62, textureX, textureY); // Box 101
		bodyModel[79] = new ModelRendererTurbo(this, 11, 59, textureX, textureY); // Box 102
		...
		bodyModel[84] = new ModelRendererTurbo(this, 49, 30, textureX, textureY); // Box 107
		...
		bodyModel[98] = new ModelRendererTurbo(this, 40, 17, textureX, textureY); // Box 121
		bodyModel[99] = new ModelRendererTurbo(this, 38, 25, textureX, textureY); // Box 122
		bodyModel[100] = new ModelRendererTurbo(this, 44, 21, textureX, textureY); // Box 123
		bodyModel[101] = new ModelRendererTurbo(this, 36, 21, textureX, textureY); // Box 124
		bodyModel[102] = new ModelRendererTurbo(this, 58, 32, textureX, textureY); // Box 125
		bodyModel[103] = new ModelRendererTurbo(this, 58, 32, textureX, textureY); // Box 126
		...
		bodyModel[118] = new ModelRendererTurbo(this, 97, 45, textureX, textureY); // Box 141
		bodyModel[119] = new ModelRendererTurbo(this, 99, 31, textureX, textureY); // Box 142
		bodyModel[120] = new ModelRendererTurbo(this, 97, 45, textureX, textureY); // Box 143
		bodyModel[121] = new ModelRendererTurbo(this, 99, 31, textureX, textureY); // Box 144
		bodyModel[122] = new ModelRendererTurbo(this, 26, 21, textureX, textureY); // Box 164
		bodyModel[123] = new ModelRendererTurbo(this, 1, 14, textureX, textureY); // Box 146
		...
		bodyModel[130] = new ModelRendererTurbo(this, 1, 14, textureX, textureY); // Box 153
		...
		bodyModel[133] = new ModelRendererTurbo(this, 78, 48, textureX, textureY); // Box 157
