...
public class ModelEvansCoilCar_Covers extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[29] = new ModelRendererTurbo(this, 82, 7, textureX, textureY); // Box 38
		...
		bodyModel[32] = new ModelRendererTurbo(this, 104, 7, textureX, textureY); // Box 38
		...
		bodyModel[0].setRotationPoint(-37.5F, -8.25F, -8.5F);

		bodyModel[1].addBox(0F, 0F, 0F, 37, 6, 5, 0F); // Box 13
		bodyModel[1].setRotationPoint(0.5F, -14.25F, -2.5F);
		...
		bodyModel[2].setRotationPoint(0.5F, -14.25F, 2.5F);
		...
		bodyModel[3].setRotationPoint(0.5F, -14.25F, -8.5F);
		...
		bodyModel[4].setRotationPoint(16F, -18F, -1.5F);
		...
		bodyModel[5].setRotationPoint(29.5F, -16F, 9F);

		bodyModel[6].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[6].setRotationPoint(7.5F, -15F, 8F);
		...
		bodyModel[7].setRotationPoint(7.5F, -16F, 9F);

		bodyModel[8].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[8].setRotationPoint(29.5F, -15F, -9F);
		...
		bodyModel[9].setRotationPoint(29.5F, -16F, -10F);

		bodyModel[10].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[10].setRotationPoint(7.5F, -15F, -9F);
		...
		bodyModel[11].setRotationPoint(7.5F, -16F, -10F);

		bodyModel[12].addBox(0F, 0F, 0F, 37, 7, 17, 0F); // Box 11 Cull
		bodyModel[12].setRotationPoint(0.5F, -8.25F, -8.5F);

		bodyModel[13].addBox(0F, 0F, 0F, 37, 6, 5, 0F); // Box 13
		bodyModel[13].setRotationPoint(-37.5F, -14.25F, -2.5F);
		...
		bodyModel[14].setRotationPoint(-37.5F, -14.25F, 2.5F);
		...
		bodyModel[15].setRotationPoint(-37.5F, -14.25F, -8.5F);
		...
		bodyModel[16].setRotationPoint(-22F, -18F, -1.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[17].setRotationPoint(-8.5F, -15F, 8F);
		...
		bodyModel[18].setRotationPoint(-8.5F, -16F, 9F);

		bodyModel[19].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[19].setRotationPoint(-30.5F, -15F, 8F);
		...
		bodyModel[20].setRotationPoint(-30.5F, -16F, 9F);

		bodyModel[21].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[21].setRotationPoint(-8.5F, -15F, -9F);
		...
		bodyModel[22].setRotationPoint(-8.5F, -16F, -10F);

		bodyModel[23].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[23].setRotationPoint(-30.5F, -15F, -9F);
		...
		bodyModel[24].setRotationPoint(-30.5F, -16F, -10F);

		bodyModel[25].addBox(0F, 0F, 0F, 37, 0, 1, 0F); // Box 34
		bodyModel[25].setRotationPoint(0.5F, -5F, 8.5F);

		bodyModel[26].addBox(0F, 0F, 0F, 37, 0, 1, 0F); // Box 34
		bodyModel[26].setRotationPoint(0.5F, -5F, -9.5F);

		bodyModel[27].addBox(0F, 0F, 0F, 37, 0, 1, 0F); // Box 34
		bodyModel[27].setRotationPoint(-37.5F, -5F, 8.5F);

		bodyModel[28].addBox(0F, 0F, 0F, 37, 0, 1, 0F); // Box 34
		bodyModel[28].setRotationPoint(-37.5F, -5F, -9.5F);

		bodyModel[29].addBox(0F, 0F, 0F, 1, 0, 19, 0F); // Box 38
		bodyModel[29].setRotationPoint(0F, -5F, -9.5F);

		bodyModel[30].addBox(0F, 0F, 0F, 1, 0, 17, 0F); // Box 38
		bodyModel[30].setRotationPoint(37F, -5F, -8.5F);

		bodyModel[31].addBox(0F, 0F, 0F, 1, 0, 17, 0F); // Box 38
		bodyModel[31].setRotationPoint(-38F, -5F, -8.5F);

		bodyModel[32].addBox(0F, 0F, 0F, 1, 0, 19, 0F); // Box 38
		bodyModel[32].setRotationPoint(-1F, -5F, -9.5F);
		...
		bodyModel[33].setRotationPoint(-0.5F, -14.25F, -6F);
		...
		bodyModel[34].setRotationPoint(-0.5F, -14.25F, 0F);

		bodyModel[35].addBox(0F, 0F, 0F, 37, 5, 12, 0F); // Box 19
		bodyModel[35].setRotationPoint(-37.5F, -12.25F, -6F);
		...
		bodyModel[36].setRotationPoint(0.5F, -14.25F, -6F);
		...
		bodyModel[43].setRotationPoint(29.5F, -15F, 4F);
		...
		bodyModel[44].setRotationPoint(7.5F, -15F, 4F);
		...
		bodyModel[45].setRotationPoint(29.5F, -15F, -8F);
		...
		bodyModel[46].setRotationPoint(7.5F, -15F, -8F);
		...
		bodyModel[47].setRotationPoint(-8.5F, -15F, 4F);
		...
		bodyModel[48].setRotationPoint(-30.5F, -15F, 4F);
		...
		bodyModel[49].setRotationPoint(-8.5F, -15F, -8F);
		...
		bodyModel[50].setRotationPoint(-30.5F, -15F, -8F);
		...
		bodyModel[51].setRotationPoint(-22F, -18F, 0F);
		...
		bodyModel[52].setRotationPoint(-22F, -18F, -2F);
		...
		bodyModel[53].setRotationPoint(16F, -18F, 0F);

		bodyModel[54].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 74 Hook thing cull
		bodyModel[54].setRotationPoint(29.5F, -15F, 8F);
		...
		bodyModel[55].setRotationPoint(-37.5F, -14.25F, -6F);
		...
		bodyModel[56].setRotationPoint(-37.5F, -14.25F, 0F);

		bodyModel[57].addBox(0F, 0F, 0F, 1, 6, 17, 0F); // Box 80  GTW mega coil stuff
		bodyModel[57].setRotationPoint(-0.5F, -7.25F, -8.5F);
		...
		bodyModel[58].setRotationPoint(-3F, -18F, -1.5F);
		...
		bodyModel[59].setRotationPoint(-3F, -18F, 0F);
		...
		bodyModel[63].setRotationPoint(-30.5F, -15F, -2F);
		...
		bodyModel[64].setRotationPoint(16F, -18F, -2F);
		...
		bodyModel[65].setRotationPoint(36.5F, -14.25F, 0F);
		...
		bodyModel[66].setRotationPoint(36.5F, -14.25F, -6F);
		...
		bodyModel[67].setRotationPoint(36.5F, -7.25F, -8.5F);
		...
		bodyModel[68].setRotationPoint(36.5F, -12.25F, -6F);
		...
		bodyModel[69].setRotationPoint(36.5F, -7.25F, 6F);
		...
		bodyModel[70].setRotationPoint(0.5F, -14.25F, -6F);
		...
		bodyModel[71].setRotationPoint(0.5F, -14.25F, 0F);
		...
		bodyModel[72].setRotationPoint(0.5F, -7.25F, 5.5F);
		...
		bodyModel[73].setRotationPoint(0.5F, -12.25F, -6F);
		...
		bodyModel[74].setRotationPoint(0.5F, -7.25F, -9F);
		...
		bodyModel[75].setRotationPoint(-1.5F, -14.25F, 0F);
		...
		bodyModel[76].setRotationPoint(-1.5F, -14.25F, -6F);
		...
		bodyModel[77].setRotationPoint(-1.5F, -7.25F, -8.5F);
		...
		bodyModel[78].setRotationPoint(-1.5F, -12.25F, -6F);
		...
		bodyModel[79].setRotationPoint(-1.5F, -7.25F, 6F);
		...
		bodyModel[80].setRotationPoint(-37.5F, -14.25F, -6F);
		...
		bodyModel[81].setRotationPoint(-37.5F, -14.25F, 0F);
		...
		bodyModel[82].setRotationPoint(-37.5F, -7.25F, 5.5F);
		...
		bodyModel[83].setRotationPoint(-37.5F, -12.25F, -6F);
		...
		bodyModel[84].setRotationPoint(-37.5F, -7.25F, -9F);

		bodyModel[85].addBox(0F, 0F, 0F, 1, 6, 1, 0F); // Box 123
		bodyModel[85].setRotationPoint(18.5F, -7.25F, -9.5F);

		bodyModel[86].addBox(0F, 0F, 0F, 1, 6, 1, 0F); // Box 123
		bodyModel[86].setRotationPoint(18.5F, -7.25F, 8.5F);
		...
		bodyModel[87].setRotationPoint(18.5F, -15.25F, 0F);
		...
		bodyModel[88].setRotationPoint(18.5F, -15.25F, -7F);

		bodyModel[89].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[89].setRotationPoint(27.5F, -9.25F, -9.5F);

		bodyModel[90].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[90].setRotationPoint(27.5F, -9.25F, 6.5F);

		bodyModel[91].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[91].setRotationPoint(9.5F, -9.25F, -9.5F);

		bodyModel[92].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[92].setRotationPoint(9.5F, -9.25F, 6.5F);

		bodyModel[93].addBox(0F, 0F, 0F, 1, 6, 1, 0F); // Box 123
		bodyModel[93].setRotationPoint(-19.5F, -7.25F, -9.5F);

		bodyModel[94].addBox(0F, 0F, 0F, 1, 6, 1, 0F); // Box 123
		bodyModel[94].setRotationPoint(-19.5F, -7.25F, 8.5F);
		...
		bodyModel[95].setRotationPoint(-19.5F, -15.25F, 0F);
		...
		bodyModel[96].setRotationPoint(-19.5F, -15.25F, -7F);

		bodyModel[97].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[97].setRotationPoint(-10.5F, -9.25F, -9.5F);

		bodyModel[98].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[98].setRotationPoint(-10.5F, -9.25F, 6.5F);

		bodyModel[99].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[99].setRotationPoint(-28.5F, -9.25F, -9.5F);

		bodyModel[100].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 129
		bodyModel[100].setRotationPoint(-28.5F, -9.25F, 6.5F);

		bodyModel[101].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 2 she coil on my gon till i...
		bodyModel[101].setRotationPoint(-34F, -15F, -3.5F);
		...
		bodyModel[102].setRotationPoint(-34F, -10F, -8.5F);
		...
		bodyModel[103].setRotationPoint(-34F, -10F, 3.5F);

		bodyModel[104].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 5 she coil on my gon till i...
		bodyModel[104].setRotationPoint(-34F, -3F, -3.5F);
		...
		bodyModel[105].setRotationPoint(-34F, -10F, -3.5F);
		...
		bodyModel[106].setRotationPoint(-34F, -10F, 1.5F);
		...
		bodyModel[107].setRotationPoint(-34F, -5F, 1.5F);
		...
		bodyModel[108].setRotationPoint(-34F, -5F, -3.5F);

		bodyModel[109].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 2 she coil on my gon till i...
		bodyModel[109].setRotationPoint(-22F, -15F, -3.5F);
		...
		bodyModel[110].setRotationPoint(-22F, -10F, -8.5F);
		...
		bodyModel[111].setRotationPoint(-22F, -10F, 3.5F);

		bodyModel[112].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 5 she coil on my gon till i...
		bodyModel[112].setRotationPoint(-22F, -3F, -3.5F);
		...
		bodyModel[113].setRotationPoint(-22F, -10F, -3.5F);
		...
		bodyModel[114].setRotationPoint(-22F, -10F, 1.5F);
		...
		bodyModel[115].setRotationPoint(-22F, -5F, 1.5F);
		...
		bodyModel[116].setRotationPoint(-22F, -5F, -3.5F);

		bodyModel[117].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 2 she coil on my gon till i...
		bodyModel[117].setRotationPoint(12F, -15F, -3.5F);
		...
		bodyModel[118].setRotationPoint(12F, -10F, -8.5F);
		...
		bodyModel[119].setRotationPoint(12F, -10F, 3.5F);

		bodyModel[120].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 5 she coil on my gon till i...
		bodyModel[120].setRotationPoint(12F, -3F, -3.5F);
		...
		bodyModel[121].setRotationPoint(12F, -10F, -3.5F);
		...
		bodyModel[122].setRotationPoint(12F, -10F, 1.5F);
		...
		bodyModel[123].setRotationPoint(12F, -5F, 1.5F);
		...
		bodyModel[124].setRotationPoint(12F, -5F, -3.5F);

		bodyModel[125].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 2 she coil on my gon till i...
		bodyModel[125].setRotationPoint(24F, -15F, -3.5F);
		...
		bodyModel[126].setRotationPoint(24F, -10F, -8.5F);
		...
		bodyModel[127].setRotationPoint(24F, -10F, 3.5F);

		bodyModel[128].addBox(0F, 0F, 0F, 10, 5, 7, 0F); // Box 5 she coil on my gon till i...
		bodyModel[128].setRotationPoint(24F, -3F, -3.5F);
		...
		bodyModel[129].setRotationPoint(24F, -10F, -3.5F);
		...
		bodyModel[130].setRotationPoint(24F, -10F, 1.5F);
		...
		bodyModel[131].setRotationPoint(24F, -5F, 1.5F);
		...
		bodyModel[132].setRotationPoint(24F, -5F, -3.5F);
		...
		bodyModel[133].setRotationPoint(29.5F, -15F, 3F);
		...
		bodyModel[134].setRotationPoint(-30.5F, -16F, -10.22F);
		...
		bodyModel[135].setRotationPoint(7.5F, -15F, 3F);
		...
		bodyModel[136].setRotationPoint(29.5F, -15F, -7F);
		...
		bodyModel[137].setRotationPoint(7.5F, -15F, -7F);
		...
		bodyModel[138].setRotationPoint(-8.5F, -15F, 3F);
		...
		bodyModel[139].setRotationPoint(-30.5F, -15F, 3F);
		...
		bodyModel[140].setRotationPoint(-8.5F, -15F, -7F);
		...
		bodyModel[141].setRotationPoint(-30.5F, -15F, -7F);
		...
		bodyModel[142].setRotationPoint(0.5F, -12.25F, 6F);
		...
		bodyModel[143].setRotationPoint(0.5F, -12.25F, -9F);
		...
		bodyModel[144].setRotationPoint(-8.5F, -16F, -10.22F);
		...
		bodyModel[145].setRotationPoint(7.5F, -16F, -10.22F);
		...
		bodyModel[146].setRotationPoint(29.5F, -16F, -10.22F);
		...
		bodyModel[147].setRotationPoint(-30.5F, -16F, 9.22F);
		...
		bodyModel[148].setRotationPoint(-8.5F, -16F, 9.22F);
		...
		bodyModel[149].setRotationPoint(7.5F, -16F, 9.22F);
		...
		bodyModel[150].setRotationPoint(29.5F, -16F, 9.22F);
		...
		bodyModel[151].setRotationPoint(-37.5F, -12.25F, 6F);
		...
		bodyModel[152].setRotationPoint(-37.5F, -12.25F, -9F);
		...
		bodyModel[153].setRotationPoint(18.5F, -15F, -7F);
		...
		bodyModel[154].setRotationPoint(18.5F, -16F, -10.22F);
		...
		bodyModel[155].setRotationPoint(18.5F, -16F, 9.22F);
		...
		bodyModel[156].setRotationPoint(-19.5F, -15F, 3F);
		...
		bodyModel[157].setRotationPoint(-19.5F, -15F, -7F);
		...
		bodyModel[158].setRotationPoint(-19.5F, -16F, -10.22F);
		...
		bodyModel[159].setRotationPoint(-19.5F, -16F, 9.22F);
		...
		bodyModel[160].setRotationPoint(18.5F, -15F, 3F);
		...
		bodyModel[161].setRotationPoint(-0.5F, -12.25F, 6F);
		...
		bodyModel[162].setRotationPoint(-0.5F, -12.25F, -8F);
		...
		bodyModel[163].setRotationPoint(0.5F, -12.25F, -9F);
		...
		bodyModel[164].setRotationPoint(0.5F, -12.25F, 6F);
		...
		bodyModel[165].setRotationPoint(-1.5F, -12.25F, 6F);
		...
		bodyModel[166].setRotationPoint(-1.5F, -12.25F, -9F);
		...
		bodyModel[167].setRotationPoint(18.5F, -13.25F, 6.5F);
		...
		bodyModel[168].setRotationPoint(18.5F, -13.25F, -9.5F);
		...
		bodyModel[169].setRotationPoint(-19.5F, -13.25F, 6.5F);
		...
		bodyModel[170].setRotationPoint(-19.5F, -13.25F, -9.5F);
		...
		bodyModel[171].setRotationPoint(36.5F, -12.25F, 6F);
		...
		bodyModel[172].setRotationPoint(36.5F, -12.25F, -9F);
		...
		bodyModel[173].setRotationPoint(-37.5F, -12.25F, -9F);
		...
		bodyModel[174].setRotationPoint(-37.5F, -12.25F, 6F);

		bodyModel[175].addBox(0F, 0F, 0F, 1, 8, 3, 0F); // Box 175
		bodyModel[175].setRotationPoint(27.5F, -9.25F, -9.5F);
		...
		bodyModel[176].setRotationPoint(5.5F, -14F, -9F);
		...
		bodyModel[177].setRotationPoint(27.5F, -14F, -9F);
		...
		bodyModel[178].setRotationPoint(5.5F, -14F, 8F);
		...
		bodyModel[179].setRotationPoint(27.5F, -14F, 8F);
		...
		bodyModel[180].setRotationPoint(-32.5F, -14F, -9F);
		...
		bodyModel[181].setRotationPoint(-10.5F, -14F, -9F);
		...
		bodyModel[182].setRotationPoint(-32.5F, -14F, 8F);
		...
		bodyModel[183].setRotationPoint(-10.5F, -14F, 8F);
	}
	@Override
