...
public class Modelgondola_load_flat_aggregates_large extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 32;

	public Modelgondola_load_flat_aggregates_large() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1] = new ModelRendererTurbo(this, 23, 5, textureX, textureY); // Box 4x FLAT AGGREGATES LORGE

		bodyModel[0].addBox(0F, 0F, 0F, 48, 1, 18, 0F); // Box 3x FLAT AGGREGATES LORGE
		bodyModel[0].setRotationPoint(-48F, 1F, -9F);

		bodyModel[1].addBox(-48F, 0F, -18F, 48, 1, 18, 0F); // Box 4x FLAT AGGREGATES LORGE
		bodyModel[1].setRotationPoint(0F, 1F, -9F);
