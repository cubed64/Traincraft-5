...
public class Modelhazmat_plac_natx30600 extends ModelConverter //Same as Filename
{
	int textureX = 32;
	int textureY = 32;

	public Modelhazmat_plac_natx30600() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(-29F, 0F, 11.04F);
		...
		bodyModel[1].setRotationPoint(29F, 0F, -11.04F);
		...
		bodyModel[2].setRotationPoint(-37.54F, 0F, 0F);
		...
		bodyModel[3].setRotationPoint(37.54F, 0F, 0F);
