...
// Model: 
// Model Creator: 
// Created on: 20.04.2025 - 18:29:50
// Last changed on: 20.04.2025 - 18:29:50
...
public class Modelgsi_53_bulk_stakes extends ModelConverter //Same as Filename
{
	int textureX = 32;
	int textureY = 32;

	public Modelgsi_53_bulk_stakes() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(-27.5F, -18F, -12F);

		bodyModel[1].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 309
		bodyModel[1].setRotationPoint(26.5F, -18F, -12F);

		bodyModel[2].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 310
		bodyModel[2].setRotationPoint(-14.5F, -18F, -12F);

		bodyModel[3].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 311
		bodyModel[3].setRotationPoint(13.5F, -18F, -12F);

		bodyModel[4].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 312
		bodyModel[4].setRotationPoint(-0.5F, -18F, -12F);

		bodyModel[5].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 313
		bodyModel[5].setRotationPoint(-27.5F, -18F, 11F);

		bodyModel[6].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 314
		bodyModel[6].setRotationPoint(26.5F, -18F, 11F);

		bodyModel[7].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 315
		bodyModel[7].setRotationPoint(-14.5F, -18F, 11F);

		bodyModel[8].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 316
		bodyModel[8].setRotationPoint(13.5F, -18F, 11F);

		bodyModel[9].addBox(0F, 0F, 0F, 1, 21, 1, 0F); // Box 317
		bodyModel[9].setRotationPoint(-0.5F, -18F, 11F);
	}
}