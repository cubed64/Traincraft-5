...
public class ModelACFRailboxCushioned extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[8].setRotationPoint(-40F, -21F, -11F);
		...
		bodyModel[9].setRotationPoint(-40F, -21F, 0F);
		...
		bodyModel[11].setRotationPoint(39.5F, -21F, 0F);

		bodyModel[12].addBox(0F, 0F, 0F, 1, 24, 20, 0F); // Box 6
		bodyModel[12].setRotationPoint(-39.5F, -20F, -10F);

		bodyModel[13].addBox(0F, 0F, 0F, 1, 24, 20, 0F); // Box 6
		bodyModel[13].setRotationPoint(38.5F, -20F, -10F);
		...
		bodyModel[14].setRotationPoint(-10.5F, -19F, -11F);

		bodyModel[15].addBox(0F, 0F, 0F, 2, 23, 1, 0F); // Box 21
		bodyModel[15].setRotationPoint(8.5F, -19F, -11F);

		bodyModel[16].addBox(0F, 0F, 0F, 29, 23, 1, 0F); // Box 8
		bodyModel[16].setRotationPoint(-39.5F, -19F, 9.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 2, 23, 1, 0F); // Box 21
		bodyModel[17].setRotationPoint(-10.5F, -19F, 10F);

		bodyModel[18].addBox(0F, 0F, 0F, 2, 23, 1, 0F); // Box 21
		bodyModel[18].setRotationPoint(8.5F, -19F, 10F);

		bodyModel[19].addBox(0F, 0F, 0F, 29, 23, 1, 0F); // Box 8
		bodyModel[19].setRotationPoint(10.5F, -19F, -10.5F);

		bodyModel[20].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[20].setRotationPoint(-40.5F, -19F, 10F);

		bodyModel[21].addBox(0F, 0F, 0F, 29, 23, 1, 0F); // Box 8
		bodyModel[21].setRotationPoint(10.5F, -19F, 9.5F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[22].setRotationPoint(-35.5F, -19F, -11F);
		...
		bodyModel[23].setRotationPoint(36F, 3.99F, 9.5F);
		...
		bodyModel[24].setRotationPoint(36F, 3.99F, -10.5F);
		...
		bodyModel[25].setRotationPoint(-39F, 3.99F, -10.5F);
		...
		bodyModel[26].setRotationPoint(-39F, 3.99F, 9.5F);

		bodyModel[27].addBox(0F, 0F, 0F, 77, 2, 20, 0F); // Box 16
		bodyModel[27].setRotationPoint(-38.5F, -20F, -10F);

		bodyModel[28].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[28].setRotationPoint(-40.5F, -19F, -11F);

		bodyModel[29].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[29].setRotationPoint(39.5F, -19F, 10F);

		bodyModel[30].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[30].setRotationPoint(39.5F, -19F, -11F);

		bodyModel[31].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[31].setRotationPoint(34.5F, -19F, -11F);

		bodyModel[32].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[32].setRotationPoint(-35.5F, -19F, 10F);

		bodyModel[33].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[33].setRotationPoint(34.5F, -19F, 10F);
		...
		bodyModel[34].setRotationPoint(-33F, 4F, 9.49F);

		bodyModel[35].addBox(0F, 0F, 0F, 46, 1, 1, 0F); // Box 76
		bodyModel[35].setRotationPoint(-23F, 5F, 9.49F);
		...
		bodyModel[36].setRotationPoint(23F, 5F, 9.49F);
		...
		bodyModel[37].setRotationPoint(-29F, 5F, 9.49F);
		...
		bodyModel[38].setRotationPoint(-33F, 4F, -10.49F);

		bodyModel[39].addBox(0F, 0F, 0F, 46, 1, 1, 0F); // Box 76
		bodyModel[39].setRotationPoint(-23F, 5F, -10.49F);
		...
		bodyModel[40].setRotationPoint(23F, 5F, -10.49F);
		...
		bodyModel[41].setRotationPoint(-29F, 5F, -10.49F);
		...
		bodyModel[42].setRotationPoint(-25.5F, -19.5F, 10.5F);
		...
		bodyModel[43].setRotationPoint(-25.5F, 3.51F, 10.5F);
		...
		bodyModel[44].setRotationPoint(-9.5F, -19.5F, -11.5F);
		...
		bodyModel[45].setRotationPoint(-9.5F, 3.51F, -11.5F);

		bodyModel[46].addBox(0F, 0F, 0F, 3, 1, 13, 0F); // Box 56 crossover cull
		bodyModel[46].setRotationPoint(39.51F, 3F, -6.5F);

		bodyModel[47].addBox(0F, 0F, 0F, 0, 3, 4, 0F); // Box 57 cull
		bodyModel[47].setRotationPoint(-40.01F, -2F, -6F);

		bodyModel[48].addBox(0F, 0F, 0F, 80, 23, 0, 0F); // side shid cull
		bodyModel[48].setRotationPoint(-40F, -19F, 11.01F);

		bodyModel[49].addBox(0F, 0F, 0F, 80, 23, 0, 0F); // side shid cull
		bodyModel[49].setRotationPoint(-40F, -19F, -11.01F);
		...
		bodyModel[50].setRotationPoint(27F, 4F, -9.5F);
		...
		bodyModel[51].setRotationPoint(-32F, 4F, -9.5F);
		...
		bodyModel[52].setRotationPoint(-32F, 4F, 2.5F);
		...
		bodyModel[53].setRotationPoint(27F, 4F, 2.5F);

		bodyModel[54].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[54].setRotationPoint(-4F, 3.99F, -9.5F);

		bodyModel[55].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[55].setRotationPoint(3F, 3.99F, -9.5F);

		bodyModel[56].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[56].setRotationPoint(-19F, 3.99F, -9.5F);

		bodyModel[57].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[57].setRotationPoint(18F, 3.99F, -9.5F);

		bodyModel[58].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[58].setRotationPoint(-11F, 3.99F, -9.5F);

		bodyModel[59].addBox(0F, 0F, 0F, 1, 2, 19, 0F); // Box 141
		bodyModel[59].setRotationPoint(11F, 3.99F, -9.5F);
		...
		bodyModel[64].setRotationPoint(-40.51F, 4F, 9F);

		bodyModel[65].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 215
		bodyModel[65].setRotationPoint(-40.5F, 5.5F, 9F);
		...
		bodyModel[66].setRotationPoint(39.51F, 4F, -10F);

		bodyModel[67].addBox(0F, 0F, 0F, 0, 2, 1, 0F); // Box 215
		bodyModel[67].setRotationPoint(40.5F, 5.5F, -10F);

		bodyModel[68].addBox(0F, 0F, 0F, 17, 23, 1, 0F); // Box 6
		bodyModel[68].setRotationPoint(-8.5F, -18.5F, 10F);

		bodyModel[69].addBox(0F, 0F, 0F, 17, 23, 1, 0F); // Box 6
		bodyModel[69].setRotationPoint(-8.5F, -18.5F, -11F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[70].setRotationPoint(-25.5F, -19F, -11F);

		bodyModel[71].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[71].setRotationPoint(-20.5F, -19F, -11F);

		bodyModel[72].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[72].setRotationPoint(-15.5F, -19F, -11F);

		bodyModel[73].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[73].setRotationPoint(-30.5F, -19F, -11F);

		bodyModel[74].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[74].setRotationPoint(-25.5F, -19F, 10F);

		bodyModel[75].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[75].setRotationPoint(-20.5F, -19F, 10F);

		bodyModel[76].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[76].setRotationPoint(-15.5F, -19F, 10F);

		bodyModel[77].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[77].setRotationPoint(-30.5F, -19F, 10F);

		bodyModel[78].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[78].setRotationPoint(24.5F, -19F, -11F);

		bodyModel[79].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[79].setRotationPoint(19.5F, -19F, -11F);

		bodyModel[80].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[80].setRotationPoint(14.5F, -19F, -11F);

		bodyModel[81].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[81].setRotationPoint(29.5F, -19F, -11F);

		bodyModel[82].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[82].setRotationPoint(24.5F, -19F, 10F);

		bodyModel[83].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[83].setRotationPoint(19.5F, -19F, 10F);

		bodyModel[84].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[84].setRotationPoint(29.5F, -19F, 10F);

		bodyModel[85].addBox(0F, 0F, 0F, 1, 23, 1, 0F); // Box 23
		bodyModel[85].setRotationPoint(14.5F, -19F, 10F);
		...
		bodyModel[86].setRotationPoint(39.5F, -9.9F, -10F);
		...
		bodyModel[87].setRotationPoint(39.5F, -17.5F, -10F);
		...
		bodyModel[88].setRotationPoint(39.5F, 1.5F, -10F);
		...
		bodyModel[89].setRotationPoint(39.5F, -2.3F, -10F);
		...
		bodyModel[90].setRotationPoint(39.5F, -6.1F, -10F);
		...
		bodyModel[91].setRotationPoint(39.5F, -13.7F, -10F);
		...
		bodyModel[92].setRotationPoint(-40.5F, -9.9F, -10F);
		...
		bodyModel[93].setRotationPoint(-40.5F, -17.5F, -10F);
		...
		bodyModel[94].setRotationPoint(-40.5F, 1.5F, -10F);
		...
		bodyModel[95].setRotationPoint(-40.5F, -2.3F, -10F);
		...
		bodyModel[96].setRotationPoint(-40.5F, -6.1F, -10F);
		...
		bodyModel[97].setRotationPoint(-40.5F, -13.7F, -10F);

		bodyModel[98].addBox(0F, 0F, 0F, 3, 1, 13, 0F); // Box 56 crossover cull
		bodyModel[98].setRotationPoint(-42.51F, 3F, -6.5F);
		...
		bodyModel[99].setRotationPoint(-28F, 6.5F, 0F);

		bodyModel[100].addBox(0F, 0F, 0F, 0, 11, 22, 0F); // Box 57 cull
		bodyModel[100].setRotationPoint(-40.51F, -7F, -11F);

		bodyModel[101].addBox(0F, 0F, 0F, 0, 11, 22, 0F); // Box 144
		bodyModel[101].setRotationPoint(40.51F, -7F, -11F);

		bodyModel[102].addBox(0F, 0F, 0F, 0, 3, 4, 0F); // Box 146
		bodyModel[102].setRotationPoint(40.01F, -2F, 2F);
		...
		bodyModel[103].setRotationPoint(28F, 4F, -10.5F);
		...
		bodyModel[104].setRotationPoint(-30F, 4F, -10.5F);

		bodyModel[105].addBox(0F, 0F, 0F, 3, 2, 3, 0F); // Box 178
		bodyModel[105].setRotationPoint(-46.5F, 4F, -1.5F);

		bodyModel[106].addBox(0F, 0F, 0F, 3, 2, 3, 0F); // Box 179
		bodyModel[106].setRotationPoint(43.5F, 4F, -1.5F);

		bodyModel[107].addBox(0F, 0F, 0F, 87, 2, 5, 0F); // Box 177
		bodyModel[107].setRotationPoint(-43.5F, 4F, -2.5F);
		...
		bodyModel[110].setRotationPoint(-41F, 4.5F, 4F);
		...
		bodyModel[111].setRotationPoint(-2F, 6.5F, -5.5F);
		...
		bodyModel[112].setRotationPoint(0F, 6.5F, -5.5F);
		...
		bodyModel[113].setRotationPoint(-1F, 4F, -4.5F);
		...
		bodyModel[114].setRotationPoint(-1F, 6F, 4F);
		...
		bodyModel[158].setRotationPoint(21F, 6.5F, -3.5F);
		...
		bodyModel[159].setRotationPoint(21F, 6.5F, -5.5F);
		...
		bodyModel[160].setRotationPoint(20F, 4F, -4.5F);
