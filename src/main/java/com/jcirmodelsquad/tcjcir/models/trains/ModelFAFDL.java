...
public class ModelFAFDL extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[26] = new ModelRendererTurbo(this, 35, 112, textureX, textureY); // Box 0 cull
		...
		bodyModel[54] = new ModelRendererTurbo(this, 77, 102, textureX, textureY); // Box 0 cull
		...
		bodyModel[59] = new ModelRendererTurbo(this, 2, 97, textureX, textureY); // Box 325 cull
		...
		bodyModel[97] = new ModelRendererTurbo(this, 66, 60, textureX, textureY); // Numberboard L type 2
		bodyModel[98] = new ModelRendererTurbo(this, 78, 71, textureX, textureY); // Markerlight L type 2
		bodyModel[99] = new ModelRendererTurbo(this, 3, 71, textureX, textureY); // Markerlight R type 2
		...
		bodyModel[135] = new ModelRendererTurbo(this, 8, 60, textureX, textureY); // Numberboard R type 2
		...
		bodyModel[240] = new ModelRendererTurbo(this, 472, 127, textureX, textureY); // Markerlight R type 1
		...
		bodyModel[243] = new ModelRendererTurbo(this, 86, 127, textureX, textureY); // Markerlight L type 1
		bodyModel[244] = new ModelRendererTurbo(this, 92, 126, textureX, textureY); // Numberboard L type 1
		bodyModel[245] = new ModelRendererTurbo(this, 465, 126, textureX, textureY); // Numberboard R type 1
		...
		bodyModel[256] = new ModelRendererTurbo(this, 137, 103, textureX, textureY); // Box 6 Front Vent Cull
		...
		bodyModel[261] = new ModelRendererTurbo(this, 308, 26, textureX, textureY); // Box 0 CP winterization hatch cull FA/FPA-2
		bodyModel[262] = new ModelRendererTurbo(this, 310, 16, textureX, textureY); // Box 0 CP winterization hatch cull FA/FPA-2
		bodyModel[263] = new ModelRendererTurbo(this, 297, 19, textureX, textureY); // Box 0 CP winterization hatch cull FA/FPA-2
		bodyModel[264] = new ModelRendererTurbo(this, 329, 19, textureX, textureY); // Box 0 CP winterization hatch cull FA/FPA-2
		...
		bodyModel[284] = new ModelRendererTurbo(this, 290, 123, textureX, textureY); // backing light type 1
		bodyModel[285] = new ModelRendererTurbo(this, 283, 123, textureX, textureY); // backing light type 1 socket
		bodyModel[286] = new ModelRendererTurbo(this, 28, 118, textureX, textureY); // Headlight BR
		bodyModel[287] = new ModelRendererTurbo(this, 28, 118, textureX, textureY); // Headlight BL
		...
		bodyModel[293] = new ModelRendererTurbo(this, 203, 53, textureX, textureY); // Box 6 PRIME1-1
		bodyModel[294] = new ModelRendererTurbo(this, 203, 53, textureX, textureY); // Box 7 PRIME1-3
		bodyModel[295] = new ModelRendererTurbo(this, 203, 53, textureX, textureY); // Box 8 PRIME1-2
		bodyModel[296] = new ModelRendererTurbo(this, 203, 53, textureX, textureY); // Box 9 PRIME1-4
		bodyModel[297] = new ModelRendererTurbo(this, 185, 53, textureX, textureY); // Box 495 c ull
		...
		bodyModel[308] = new ModelRendererTurbo(this, 137, 103, textureX, textureY); // Box 6 Front Vent Cull
		...
		bodyModel[313] = new ModelRendererTurbo(this, 29, 128, textureX, textureY); // Box 445 ditchlight front b
		bodyModel[314] = new ModelRendererTurbo(this, 20, 128, textureX, textureY); // Ditchlight box
		bodyModel[315] = new ModelRendererTurbo(this, 29, 128, textureX, textureY); // Box 445 ditchlight front b
		bodyModel[316] = new ModelRendererTurbo(this, 20, 128, textureX, textureY); // Ditchlight box
		bodyModel[317] = new ModelRendererTurbo(this, 27, 103, textureX, textureY); // Box 0 cull
		bodyModel[318] = new ModelRendererTurbo(this, 27, 103, textureX, textureY); // Box 0 cull
		bodyModel[319] = new ModelRendererTurbo(this, 5, 123, textureX, textureY); // Headlight TB
		bodyModel[320] = new ModelRendererTurbo(this, 5, 118, textureX, textureY); // Headlight TT
		bodyModel[321] = new ModelRendererTurbo(this, 13, 128, textureX, textureY); // Headlight BB
		bodyModel[322] = new ModelRendererTurbo(this, 13, 123, textureX, textureY); // Headlight BT
		...
		bodyModel[328] = new ModelRendererTurbo(this, 167, 57, textureX, textureY); // Box 6 PRIME1-1
		bodyModel[329] = new ModelRendererTurbo(this, 167, 57, textureX, textureY); // Box 7 PRIME1-3
		bodyModel[330] = new ModelRendererTurbo(this, 167, 57, textureX, textureY); // Box 8 PRIME1-2
		bodyModel[331] = new ModelRendererTurbo(this, 167, 57, textureX, textureY); // Box 9 PRIME1-4
