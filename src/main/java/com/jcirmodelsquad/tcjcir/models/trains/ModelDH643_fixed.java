...
public class ModelDH643_fixed extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public ModelDH643_fixed() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 175, 117, textureX, textureY); // Box 6
		...
		bodyModel[16] = new ModelRendererTurbo(this, 222, 116, textureX, textureY); // Box 48
		...
		bodyModel[52] = new ModelRendererTurbo(this, 324, 140, textureX, textureY, "lamp"); // Box 448 headlight front gyralight nose
		bodyModel[53] = new ModelRendererTurbo(this, 317, 140, textureX, textureY, "lamp"); // Box 449 headlight front gyralight nose
		...
		bodyModel[63] = new ModelRendererTurbo(this, 421, 94, textureX, textureY); // Box 178
		...
		bodyModel[170] = new ModelRendererTurbo(this, 447, 116, textureX, textureY); // Box 377
		...
		bodyModel[174] = new ModelRendererTurbo(this, 447, 81, textureX, textureY); // Box 382
		...
		bodyModel[259] = new ModelRendererTurbo(this, 270, 160, textureX, textureY); // Box 114 bell
		bodyModel[260] = new ModelRendererTurbo(this, 270, 160, textureX, textureY); // Box 74 bell
		bodyModel[261] = new ModelRendererTurbo(this, 270, 163, textureX, textureY); // Box 78 bell
		bodyModel[262] = new ModelRendererTurbo(this, 268, 156, textureX, textureY, "cull"); // Box 875 cull bell holder
		bodyModel[263] = new ModelRendererTurbo(this, 258, 126, textureX, textureY); // Box 327 lrr horn
		bodyModel[264] = new ModelRendererTurbo(this, 260, 123, textureX, textureY); // Box 328 lrr horn
		bodyModel[265] = new ModelRendererTurbo(this, 260, 129, textureX, textureY); // Box 329 lrr horn
		bodyModel[266] = new ModelRendererTurbo(this, 269, 126, textureX, textureY); // Box 330 lrr horn
		bodyModel[267] = new ModelRendererTurbo(this, 253, 123, textureX, textureY); // Box 331 lrr horn
		bodyModel[268] = new ModelRendererTurbo(this, 253, 129, textureX, textureY); // Box 332 lrr horn
		bodyModel[269] = new ModelRendererTurbo(this, 105, 135, textureX, textureY); // Box 278 dofasco mount
		bodyModel[270] = new ModelRendererTurbo(this, 111, 129, textureX, textureY); // Box 279 dofasco mount
		bodyModel[271] = new ModelRendererTurbo(this, 105, 135, textureX, textureY); // Box 280 dofasco mount
		bodyModel[272] = new ModelRendererTurbo(this, 111, 129, textureX, textureY); // Box 281 dofasco mount
		bodyModel[273] = new ModelRendererTurbo(this, 271, 120, textureX, textureY); // Box 290 lrr antenna
		bodyModel[274] = new ModelRendererTurbo(this, -7, 12, textureX, textureY); // Box 274 radiator hd
		bodyModel[275] = new ModelRendererTurbo(this, -9, 1, textureX, textureY); // Box 276 radiator hd
		bodyModel[276] = new ModelRendererTurbo(this, -9, 21, textureX, textureY); // Box 277 radiator hd
		bodyModel[277] = new ModelRendererTurbo(this, 247, 129, textureX, textureY); // Box 409 commander base
		bodyModel[278] = new ModelRendererTurbo(this, 247, 125, textureX, textureY, "commander"); // Box 410 commander beacon
		bodyModel[279] = new ModelRendererTurbo(this, 201, 131, textureX, textureY, "cull"); // Box 339 cull crossover
		bodyModel[280] = new ModelRendererTurbo(this, 222, 130, textureX, textureY, "cull"); // Box 328 cull crossover
		bodyModel[281] = new ModelRendererTurbo(this, 194, 132, textureX, textureY); // Box 398 not a ditchlight will not glow
		...
		bodyModel[2].setRotationPoint(-32F, -21F, -7F);

		bodyModel[3].addBox(0F, 0F, 0F, 94, 0, 4, 0F); // Box 0
		bodyModel[3].setRotationPoint(-47F, -1F, -11F);

		bodyModel[4].addBox(0F, 0F, 0F, 5, 2, 2, 0F); // Box 4
		bodyModel[4].setRotationPoint(-52F, -1F, -9F);

		bodyModel[5].addBox(0F, 0F, 0F, 0, 8, 20, 0F); // Box 6
		bodyModel[5].setRotationPoint(-52.01F, -1F, -10F);

		bodyModel[6].addBox(0F, 0F, 0F, 0, 9, 2, 0F); // Box 8
		bodyModel[6].setRotationPoint(-48F, -1F, -11F);
		...
		bodyModel[12].addBox(0F, 0F, 0F, 0, 9, 2, 0F); // Box 116
		bodyModel[12].setRotationPoint(-48F, -1F, 9F);
		...
		bodyModel[16].addBox(0F, 0F, 0F, 0, 8, 20, 0F); // Box 48
		bodyModel[16].setRotationPoint(52.01F, -1F, -10F);
		...
		bodyModel[19].setRotationPoint(-52F, -1F, -7F);

		bodyModel[20].addBox(0F, 0F, 0F, 5, 13, 14, 0F); // Box 25
		bodyModel[20].setRotationPoint(-49F, -14F, -7F);
		...
		bodyModel[21].setRotationPoint(-50F, -14F, -6F);
		...
		bodyModel[22].setRotationPoint(-49F, -15F, -7F);
		...
		bodyModel[23].setRotationPoint(-49F, -15F, 2F);

		bodyModel[24].addBox(0F, 0F, 0F, 6, 1, 4, 0F); // Box 28
		bodyModel[24].setRotationPoint(-50F, -15F, -2F);
		...
		bodyModel[25].setRotationPoint(-50F, -15F, -7F);
		...
		bodyModel[27].setRotationPoint(-48F, -1F, -11F);
		...
		bodyModel[28].setRotationPoint(-48F, -1F, 9F);
		...
		bodyModel[32].setRotationPoint(-44F, -6F, -11F);

		bodyModel[33].addBox(0F, 0F, 0F, 10, 12, 1, 0F); // Box 29
		bodyModel[33].setRotationPoint(-43F, -18F, -11F);

		bodyModel[34].addBox(0F, 0F, 0F, 10, 12, 1, 0F); // Box 32
		bodyModel[34].setRotationPoint(-43F, -18F, 10F);

		bodyModel[35].addBox(0F, 0F, 0F, 12, 1, 6, 0F); // Box 135
		bodyModel[35].setRotationPoint(-44F, -23F, -3F);
		...
		bodyModel[36].setRotationPoint(-43F, -23F, -8F);
		...
		bodyModel[37].setRotationPoint(-43F, -21F, -10F);

		bodyModel[38].addBox(0F, 0F, 0F, 5, 2, 2, 0F); // Box 205
		bodyModel[38].setRotationPoint(-52F, -1F, 7F);

		bodyModel[39].addBox(0F, 0F, 0F, 94, 0, 4, 0F); // Box 206
		bodyModel[39].setRotationPoint(-47F, -1F, 7F);

		bodyModel[40].addBox(0F, 0F, 0F, 1, 12, 18, 0F); // Box 406
		bodyModel[40].setRotationPoint(-33F, -18F, -11F);

		bodyModel[41].addBox(0F, 0F, 0F, 1, 2, 20, 0F); // Box 407
		bodyModel[41].setRotationPoint(-33F, -20F, -10F);

		bodyModel[42].addBox(0F, 0F, 0F, 1, 1, 6, 0F); // Box 408
		bodyModel[42].setRotationPoint(-33F, -22F, -3F);

		bodyModel[43].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 409
		bodyModel[43].setRotationPoint(-33F, -21F, -8F);
		...
		bodyModel[44].setRotationPoint(-33F, -23F, -8F);
		...
		bodyModel[45].setRotationPoint(-33F, -21F, -10F);
		...
		bodyModel[46].setRotationPoint(-44F, -21F, -10F);
		...
		bodyModel[47].setRotationPoint(-33F, -23F, 3F);
		...
		bodyModel[48].setRotationPoint(-33F, -21F, 8F);

		bodyModel[49].addBox(0F, 0F, 0F, 1, 2, 3, 0F); // Box 428
		bodyModel[49].setRotationPoint(-44F, -20F, -10F);

		bodyModel[50].addBox(-0.5F, 0F, -3.5F, 1, 12, 4, 0F); // Box 314 door swing right
		bodyModel[50].setRotationPoint(-32.5F, -18F, 10.5F);

		bodyModel[51].addBox(-0.5F, 0F, -0.5F, 1, 12, 4, 0F); // Box 315 door swing right
		bodyModel[51].setRotationPoint(-43.5F, -18F, -10.5F);

		bodyModel[52].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 448 headlight front gyralight nose
		bodyModel[52].setRotationPoint(-50.5F, -11F, -2F);

		bodyModel[53].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 449 headlight front gyralight nose
		bodyModel[53].setRotationPoint(-50.5F, -11F, 0F);

		bodyModel[54].addBox(0F, 0F, 0F, 2, 1, 3, 0F); // Box 455
		bodyModel[54].setRotationPoint(-54F, -1F, -8F);
		...
		bodyModel[55].setRotationPoint(-54F, -1F, -9F);
		...
		bodyModel[56].setRotationPoint(-54F, -1F, 8F);

		bodyModel[57].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 458
		bodyModel[57].setRotationPoint(-53F, -1F, -3F);

		bodyModel[58].addBox(0F, 0F, 0F, 5, 2, 2, 0F); // Box 471
		bodyModel[58].setRotationPoint(47F, -1F, 7F);

		bodyModel[59].addBox(0F, 0F, 0F, 5, 2, 2, 0F); // Box 472
		bodyModel[59].setRotationPoint(47F, -1F, -9F);
		...
		bodyModel[60].setRotationPoint(47F, -1F, -11F);
		...
		bodyModel[61].setRotationPoint(47F, -1F, 9F);
		...
		bodyModel[62].setRotationPoint(-32F, -22F, 3F);

		bodyModel[63].addShapeBox(0F, 0F, 0F, 30, 7, 14, 0F,2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 178
		bodyModel[63].setRotationPoint(-15F, 2F, -7F);

		bodyModel[64].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 201
		bodyModel[64].setRotationPoint(-34F, 3F, -2F);

		bodyModel[65].addBox(0F, 0F, 0F, 81, 8, 0, 0F); // Box 224
		bodyModel[65].setRotationPoint(-32F, -9F, -11F);

		bodyModel[66].addBox(0F, 0F, 0F, 76, 8, 0, 0F); // Box 225
		bodyModel[66].setRotationPoint(-27F, -9F, 11F);

		bodyModel[67].addBox(0F, 0F, 0F, 0, 9, 20, 0F); // Box 226
		bodyModel[67].setRotationPoint(-54F, -10F, -10F);
		...
		bodyModel[74].setRotationPoint(-50F, -15.5F, -1F);

		bodyModel[75].addBox(0F, 0F, 0F, 4, 3, 1, 0F); // Box 247
		bodyModel[75].setRotationPoint(-34F, -1F, 10F);

		bodyModel[76].addBox(0F, 0F, 0F, 2, 3, 20, 0F); // Box 557
		bodyModel[76].setRotationPoint(-33F, -1F, -10F);
		...
		bodyModel[77].setRotationPoint(16.5F, -1F, -11F);
		...
		bodyModel[78].setRotationPoint(-28.5F, -1F, 8F);
		...
		bodyModel[79].setRotationPoint(16.5F, -1F, 8F);
		...
		bodyModel[82].addBox(0F, 0F, 0F, 1, 13, 0, 0F); // Box 688
		bodyModel[82].setRotationPoint(-49F, -8F, 11F);
		...
		bodyModel[83].setRotationPoint(-47F, -9F, 11F);

		bodyModel[84].addBox(0F, 0F, 0F, 1, 14, 0, 0F); // Box 691
		bodyModel[84].setRotationPoint(-49F, -9F, -11F);

		bodyModel[85].addBox(0F, 0F, 0F, 2, 1, 0, 0F); // Box 693
		bodyModel[85].setRotationPoint(-46F, -14F, -11F);
		...
		bodyModel[86].setRotationPoint(-44F, -21F, -7F);
		...
		bodyModel[88].setRotationPoint(-31F, -14F, 11F);
		...
		bodyModel[89].setRotationPoint(-45F, -23F, -3F);

		bodyModel[90].addBox(0F, 0F, 0F, 2, 1, 0, 0F); // Box 276
		bodyModel[90].setRotationPoint(-49F, -9F, 11F);
		...
		bodyModel[91].setRotationPoint(-44F, -20F, -11F);
		...
		bodyModel[92].setRotationPoint(-47.25F, -21F, -2F);
		...
		bodyModel[96].setRotationPoint(-41F, -18.25F, -11.97F);
		bodyModel[96].rotateAngleX = -0.26179939F;

		bodyModel[97].addBox(0F, 0F, 0F, 1, 6, 0, 0F); // Box 275
		bodyModel[97].setRotationPoint(48F, -1F, -11F);

		bodyModel[98].addBox(0F, 0F, 0F, 1, 6, 0, 0F); // Box 276
		bodyModel[98].setRotationPoint(48F, -1F, 11F);

		bodyModel[99].addBox(0F, 0F, 0F, 4, 2, 0, 0F); // Box 277
		bodyModel[99].setRotationPoint(-52F, 1F, -9F);

		bodyModel[100].addBox(0F, 0F, 0F, 4, 0, 1, 0F); // Box 278
		bodyModel[100].setRotationPoint(-52F, 2F, -10F);

		bodyModel[101].addBox(0F, 0F, 0F, 4, 2, 0, 0F); // Box 280
		bodyModel[101].setRotationPoint(-52F, 1F, 9F);
		...
		bodyModel[108].addBox(0F, 0F, 0F, 4, 2, 0, 0F); // Box 306
		bodyModel[108].setRotationPoint(48F, 1F, -9F);

		bodyModel[109].addBox(0F, 0F, 0F, 0, 9, 2, 0F); // Box 308
		bodyModel[109].setRotationPoint(48F, -1F, -11F);

		bodyModel[110].addBox(0F, 0F, 0F, 4, 2, 0, 0F); // Box 310
		bodyModel[110].setRotationPoint(48F, 1F, 9F);
		...
		bodyModel[114].addBox(0F, 0F, 0F, 0, 9, 2, 0F); // Box 316
		bodyModel[114].setRotationPoint(48F, -1F, 9F);

		bodyModel[115].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 318
		bodyModel[115].setRotationPoint(30F, 3F, -2F);
		...
		bodyModel[119].setRotationPoint(-43F, -21F, 8F);
		...
		bodyModel[120].setRotationPoint(-44F, -20F, 10F);
		...
		bodyModel[121].setRotationPoint(-43F, -23F, 3F);

		bodyModel[122].addBox(0F, 0F, 0F, 1, 1, 14, 0F); // Box 405
		bodyModel[122].setRotationPoint(-44F, -20F, -7F);
		...
		bodyModel[123].setRotationPoint(-44F, -21F, 8F);
		...
		bodyModel[124].setRotationPoint(-45.5F, 3.5F, 9.7F);
		...
		bodyModel[125].setRotationPoint(-45.5F, 2.5F, 9.7F);
		...
		bodyModel[126].setRotationPoint(-45.25F, 4F, 9.95F);
		...
		bodyModel[127].setRotationPoint(-45.5F, 1.5F, 5.5F);

		bodyModel[128].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 319
		bodyModel[128].setRotationPoint(-45F, -25F, -0.5F);

		bodyModel[129].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 320
		bodyModel[129].setRotationPoint(-44.5F, -24F, -0.5F);

		bodyModel[130].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 321
		bodyModel[130].setRotationPoint(-46F, -24.5F, 0.5F);

		bodyModel[131].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 322
		bodyModel[131].setRotationPoint(-46F, -24.5F, -1.5F);

		bodyModel[132].addBox(0F, 0F, 0F, 1, 20, 12, 0F); // Box 299
		bodyModel[132].setRotationPoint(49F, -21F, -6F);
		...
		bodyModel[133].setRotationPoint(49F, -21F, -7F);
		...
		bodyModel[134].setRotationPoint(49F, -21F, 6F);

		bodyModel[135].addBox(0F, 0F, 0F, 82, 1, 6, 0F); // Box 303
		bodyModel[135].setRotationPoint(-32F, -22F, -3F);
		...
		bodyModel[136].setRotationPoint(49.75F, -21.5F, -1F);
		...
		bodyModel[137].setRotationPoint(49.75F, -19.5F, -1F);

		bodyModel[138].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 342
		bodyModel[138].setRotationPoint(49.5F, -21.5F, -1F);
		...
		bodyModel[139].setRotationPoint(49F, -15F, 6F);
		...
		bodyModel[140].setRotationPoint(49F, -15F, -7F);
		...
		bodyModel[141].setRotationPoint(-32.5F, -5F, 7F);
		...
		bodyModel[142].setRotationPoint(-31F, -3F, 7F);
		...
		bodyModel[143].setRotationPoint(-45.5F, -5F, -11F);
		...
		bodyModel[144].setRotationPoint(-47F, -3F, -11F);
		...
		bodyModel[145].setRotationPoint(-46F, -13F, -11F);

		bodyModel[146].addBox(0F, 0F, 0F, 6, 1, 8, 0F); // Box 350
		bodyModel[146].setRotationPoint(-35F, 2F, -4F);

		bodyModel[147].addBox(0F, 0F, 0F, 6, 1, 8, 0F); // Box 351
		bodyModel[147].setRotationPoint(29F, 2F, -4F);

		bodyModel[148].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 352
		bodyModel[148].setRotationPoint(-33F, 2F, 10F);

		bodyModel[149].addBox(0F, 0F, 0F, 4, 3, 1, 0F); // Box 353
		bodyModel[149].setRotationPoint(-34F, -1F, -11F);

		bodyModel[150].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 354
		bodyModel[150].setRotationPoint(-33F, 2F, -11F);
		...
		bodyModel[152].setRotationPoint(31F, 2F, 10F);

		bodyModel[153].addBox(0F, 0F, 0F, 4, 3, 1, 0F); // Box 358
		bodyModel[153].setRotationPoint(30F, -1F, -11F);

		bodyModel[154].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 359
		bodyModel[154].setRotationPoint(31F, 2F, -11F);

		bodyModel[155].addBox(0F, 0F, 0F, 2, 3, 20, 0F); // Box 360
		bodyModel[155].setRotationPoint(31F, -1F, -10F);

		bodyModel[156].addBox(0F, 0F, 0F, 1, 1, 0, 0F); // Box 361
		bodyModel[156].setRotationPoint(-32F, -14F, 11F);

		bodyModel[157].addBox(0F, 0F, 0F, 1, 12, 4, 0F); // Box 362
		bodyModel[157].setRotationPoint(-44F, -18F, 7F);
		...
		bodyModel[158].setRotationPoint(-44F, -21F, 2F);
		...
		bodyModel[159].setRotationPoint(-44F, -23F, 3F);
		...
		bodyModel[160].setRotationPoint(-44F, -23F, -8F);

		bodyModel[161].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 366
		bodyModel[161].setRotationPoint(-44F, -21F, -8F);

		bodyModel[162].addBox(0F, 0F, 0F, 1, 1, 6, 0F); // Box 367
		bodyModel[162].setRotationPoint(-44F, -22F, -3F);
		...
		bodyModel[163].setRotationPoint(-44F, -23F, 2F);
		...
		bodyModel[164].setRotationPoint(-44F, -23F, -7F);
		...
		bodyModel[165].setRotationPoint(-45F, -23F, 2F);
		...
		bodyModel[166].setRotationPoint(-48.25F, -23F, -1F);

		bodyModel[167].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 373
		bodyModel[167].setRotationPoint(-48F, -23F, -1F);
		...
		bodyModel[168].setRotationPoint(-52F, 1F, 7F);
		...
		bodyModel[169].setRotationPoint(-47F, -1F, 7F);

		bodyModel[170].addShapeBox(0F, 0F, 0F, 22, 8, 4, 0F,0F, 0F, 0F, 0F, 0F, 0F, 4F, 0F, 0F, 4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 4F, 2F, 0F, 4F, 2F, 0F); // Box 377
		bodyModel[170].setRotationPoint(-11F, -1F, -11F);
		...
		bodyModel[171].setRotationPoint(-52F, 1F, -8F);
		...
		bodyModel[172].setRotationPoint(-47F, -1F, -8F);
		...
		bodyModel[173].setRotationPoint(-28.5F, -1F, -11F);

		bodyModel[174].addShapeBox(0F, 0F, 0F, 22, 8, 4, 0F,4F, 0F, 0F, 4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 4F, 2F, 0F, 4F, 2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 382
		bodyModel[174].setRotationPoint(-11F, -1F, 7F);
		...
		bodyModel[175].setRotationPoint(-54F, -7F, 3F);
		...
		bodyModel[176].setRotationPoint(54F, -7F, 3F);

		bodyModel[177].addBox(0F, 0F, 0F, 0, 9, 20, 0F); // Box 389
		bodyModel[177].setRotationPoint(54F, -10F, -10F);
		...
		bodyModel[178].setRotationPoint(54F, -7F, -7F);
		...
		bodyModel[188].setRotationPoint(49F, -22F, 3F);
		...
		bodyModel[189].setRotationPoint(49F, -22F, -7F);
		...
		bodyModel[190].setRotationPoint(-32F, -22F, -7F);

		bodyModel[191].addBox(0F, 0F, 0F, 2, 2, 5, 0F); // Box 404 exhaust
		bodyModel[191].setRotationPoint(27F, -24F, -2.5F);
		...
		bodyModel[192].setRotationPoint(-44F, 0F, 9F);

		bodyModel[193].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 406
		bodyModel[193].setRotationPoint(-37F, -1F, 9F);

		bodyModel[194].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 407
		bodyModel[194].setRotationPoint(-45F, -1F, 9F);
		...
		bodyModel[203].setRotationPoint(-46F, -1F, -11F);
		...
		bodyModel[204].setRotationPoint(-13F, -21F, -8F);
		...
		bodyModel[205].setRotationPoint(-13F, -21F, 6F);
		...
		bodyModel[214].setRotationPoint(35F, -1F, -11F);
		...
		bodyModel[215].setRotationPoint(30F, -22.5F, 3F);

		bodyModel[216].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 437
		bodyModel[216].setRotationPoint(30F, -22.5F, -3F);
		...
		bodyModel[217].setRotationPoint(30F, -22.5F, -7F);

		bodyModel[218].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 440
		bodyModel[218].setRotationPoint(30F, -21.5F, -7.25F);

		bodyModel[219].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 441
		bodyModel[219].setRotationPoint(30F, -21.5F, 6.25F);

		bodyModel[220].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 442
		bodyModel[220].setRotationPoint(-32F, -21.5F, 6.25F);
		...
		bodyModel[221].setRotationPoint(-32F, -22.5F, 3F);

		bodyModel[222].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 444
		bodyModel[222].setRotationPoint(-32F, -22.5F, -3F);
		...
		bodyModel[223].setRotationPoint(-32F, -22.5F, -7F);

		bodyModel[224].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 446
		bodyModel[224].setRotationPoint(-32F, -21.5F, -7.25F);
		...
		bodyModel[225].setRotationPoint(-14F, -1F, -11F);
		...
		bodyModel[226].setRotationPoint(-14F, -1F, 11F);
		...
		bodyModel[227].setRotationPoint(11F, -1F, 11F);
		...
		bodyModel[228].setRotationPoint(11F, -1F, -11F);

		bodyModel[229].addBox(0F, 0F, 0F, 2, 1, 3, 0F); // Box 451
		bodyModel[229].setRotationPoint(-54F, -1F, 5F);

		bodyModel[230].addBox(0F, 0F, 0F, 2, 0, 10, 0F); // Box 452
		bodyModel[230].setRotationPoint(-54F, -1F, -5F);

		bodyModel[231].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 453
		bodyModel[231].setRotationPoint(52F, -1F, -3F);

		bodyModel[232].addBox(0F, 0F, 0F, 2, 1, 3, 0F); // Box 454
		bodyModel[232].setRotationPoint(52F, -1F, -8F);

		bodyModel[233].addBox(0F, 0F, 0F, 2, 1, 3, 0F); // Box 455
		bodyModel[233].setRotationPoint(52F, -1F, 5F);
		...
		bodyModel[234].setRotationPoint(52F, -1F, 8F);
		...
		bodyModel[235].setRotationPoint(52F, -1F, -9F);

		bodyModel[236].addBox(0F, 0F, 0F, 2, 0, 10, 0F); // Box 458
		bodyModel[236].setRotationPoint(52F, -1F, -5F);
		...
		bodyModel[237].setRotationPoint(15F, -21F, -7.5F);
		...
		bodyModel[238].setRotationPoint(-16F, -21F, -7.5F);
		...
		bodyModel[239].setRotationPoint(-16F, -21F, 6.5F);
		...
		bodyModel[242].setRotationPoint(-44F, -20F, 7F);
		...
		bodyModel[243].setRotationPoint(-45F, -8F, 8F);

		bodyModel[244].addBox(0F, 0F, 0F, 1, 5, 0, 0F); // Box 249
		bodyModel[244].setRotationPoint(-45F, -6F, 9F);
		...
		bodyModel[247].setRotationPoint(-44F, -19F, -7F);
		...
		bodyModel[248].setRotationPoint(-44F, -19F, 0F);

		bodyModel[249].addBox(0F, 0F, 0F, 7, 8, 3, 0F); // Box 413
		bodyModel[249].setRotationPoint(-44F, -14F, 1F);
		...
		bodyModel[256].setRotationPoint(49F, -17F, 6F);

		bodyModel[257].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 448 headlight front n
		bodyModel[257].setRotationPoint(-50.5F, -14.5F, -1F);

		bodyModel[258].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 449 headlight front n
		bodyModel[258].setRotationPoint(-50.5F, -12.5F, -1F);

		bodyModel[259].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F); // Box 114 bell
		bodyModel[259].setRotationPoint(-48.98F, -21F, -0.5F);

		bodyModel[260].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,-0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 74 bell
		bodyModel[260].setRotationPoint(-48.98F, -22F, -0.5F);

		bodyModel[261].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.5F, 0F, 0F, -0.5F); // Box 78 bell
		bodyModel[261].setRotationPoint(-48.73F, -20.5F, -0.25F);

		bodyModel[262].addShapeBox(0F, 0F, 0F, 2, 1, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, -0.5F, 0F); // Box 875 cull bell holder
		bodyModel[262].setRotationPoint(-48.98F, -22F, -1F);

		bodyModel[263].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 327 lrr horn
		bodyModel[263].setRotationPoint(-51F, -24F, -0.5F);

		bodyModel[264].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 328 lrr horn
		bodyModel[264].setRotationPoint(-50F, -23.75F, 0.5F);

		bodyModel[265].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 329 lrr horn
		bodyModel[265].setRotationPoint(-50.5F, -23.75F, -1.5F);

		bodyModel[266].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 330 lrr horn
		bodyModel[266].setRotationPoint(-48.5F, -23F, -0.5F);

		bodyModel[267].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 331 lrr horn
		bodyModel[267].setRotationPoint(-49.5F, -25F, 0.25F);

		bodyModel[268].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 332 lrr horn
		bodyModel[268].setRotationPoint(-49.5F, -25F, -1F);

		bodyModel[269].addBox(0F, 0F, 0F, 6, 1, 8, 0F); // Box 278 dofasco mount
		bodyModel[269].setRotationPoint(-39F, 2F, -4F);

		bodyModel[270].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 279 dofasco mount
		bodyModel[270].setRotationPoint(-38F, 3F, -2F);

		bodyModel[271].addBox(0F, 0F, 0F, 6, 1, 8, 0F); // Box 280 dofasco mount
		bodyModel[271].setRotationPoint(33F, 2F, -4F);

		bodyModel[272].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 281 dofasco mount
		bodyModel[272].setRotationPoint(34F, 3F, -2F);

		bodyModel[273].addBox(0F, 0F, 0F, 1, 2, 0, 0F); // Box 290 lrr antenna
		bodyModel[273].setRotationPoint(-37F, -25F, 0F);

		bodyModel[274].addShapeBox(0F, 0F, 0F, 56, 0, 8, 0F,0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -4F, 0F, 0F, -4F, 0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -4F, 0F, 0F, -4F); // Box 274 radiator hd
		bodyModel[274].setRotationPoint(-13F, -22.51F, -2F);

		bodyModel[275].addShapeBox(0F, 0F, 0F, 56, 0, 10, 0F,0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -5F, 0F, 0F, -5F); // Box 276 radiator hd
		bodyModel[275].setRotationPoint(-13F, -22.51F, 2F);
		bodyModel[275].rotateAngleX = -0.19198622F;

		bodyModel[276].addShapeBox(0F, 0F, -5F, 56, 0, 10, 0F,0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, -28F, 0F, 0F, -28F, 0F, -5F, 0F, 0F, -5F); // Box 277 radiator hd
		bodyModel[276].setRotationPoint(-13F, -22.51F, -2F);
		bodyModel[276].rotateAngleX = 0.19198622F;
		...
		bodyModel[277].setRotationPoint(-40F, -24F, -0.5F);
		...
		bodyModel[278].setRotationPoint(-40F, -25F, -0.5F);

		bodyModel[279].addBox(-3F, 0F, 0F, 3, 1, 4, 0F); // Box 339 cull crossover
		bodyModel[279].setRotationPoint(-53.5F, -1.1F, -2F);
		bodyModel[279].rotateAngleZ = -1.48352986F;

		bodyModel[280].addBox(-3F, 0F, 0F, 3, 1, 4, 0F); // Box 328 cull crossover
		bodyModel[280].setRotationPoint(53.5F, -1.1F, 2F);
		bodyModel[280].rotateAngleY = -3.14159265F;
		bodyModel[280].rotateAngleZ = -1.48352986F;

		bodyModel[281].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 398 not a ditchlight will not glow
		bodyModel[281].setRotationPoint(-53F, -0.5F, -5F);

		bodyModel[282].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,-0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F); // Box 398 not a ditchlight will not glow
		bodyModel[282].setRotationPoint(-53F, -0.5F, 3F);

		bodyModel[283].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 398 not a ditchlight will not glow
		bodyModel[283].setRotationPoint(52F, -0.5F, -5F);

		bodyModel[284].addShapeBox(0F, 0F, 0F, 1, 2, 2, 0F,0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, -0.25F, 0F, -0.25F, -0.25F); // Box 398 not a ditchlight will not glow
		bodyModel[284].setRotationPoint(52F, -0.5F, 3F);

		bodyModel[285].addBox(0F, -1F, 2F, 1, 1, 1, 0F); // Box 286 markerlight glow
		bodyModel[285].setRotationPoint(-44.31F, -21F, -6.5F);
		bodyModel[285].rotateAngleY = 0.54105207F;

		bodyModel[286].addBox(0F, -1F, -3F, 1, 1, 1, 0F); // Box 287 markerlight glow
		bodyModel[286].setRotationPoint(-44.31F, -21F, 6.5F);
		bodyModel[286].rotateAngleY = -0.54105207F;
	}
	ModelMLW_3axle_Hiad theTruc2 = new ModelMLW_3axle_Hiad();
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (entity instanceof AbstractTrains && ((AbstractTrains) entity).getColor() == 14321){
			...
			theTruc2.render(entity, f, f1, f2, f3, f4, f5);
