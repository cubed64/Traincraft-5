...
public class ModelSB18E extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[170] = new ModelRendererTurbo(this, 174, 55, textureX, textureY, "lamp"); // Box 6 PRIME4-1
		bodyModel[171] = new ModelRendererTurbo(this, 174, 55, textureX, textureY, "lamp"); // Box 7 PRIME4-3
		bodyModel[172] = new ModelRendererTurbo(this, 174, 55, textureX, textureY, "lamp"); // Box 8 PRIME4-2
		bodyModel[173] = new ModelRendererTurbo(this, 174, 55, textureX, textureY, "lamp"); // Box 9 PRIME4-4
		...
		bodyModel[203] = new ModelRendererTurbo(this, 134, 52, textureX, textureY, "lamp"); // Box 410 commander beacon
		bodyModel[204] = new ModelRendererTurbo(this, 144, 53, textureX, textureY); // Box 409 commander base
		bodyModel[205] = new ModelRendererTurbo(this, 139, 52, textureX, textureY, "lamp"); // Box 410 commander beacon
		...
		bodyModel[286] = new ModelRendererTurbo(this, 126, 9, textureX, textureY, "lamp"); // Box 410 commander beacon
		bodyModel[287] = new ModelRendererTurbo(this, 126, 24, textureX, textureY); // Box 409 commander base
		bodyModel[288] = new ModelRendererTurbo(this, 126, 20, textureX, textureY, "lamp"); // Box 410 commander beacon
		bodyModel[289] = new ModelRendererTurbo(this, 132, 18, textureX, textureY); // Box 421 prime base
		bodyModel[290] = new ModelRendererTurbo(this, 132, 14, textureX, textureY, "lamp"); // Box 6 PRIME2-1
		bodyModel[291] = new ModelRendererTurbo(this, 132, 14, textureX, textureY, "lamp"); // Box 7 PRIME2-3
		bodyModel[292] = new ModelRendererTurbo(this, 132, 14, textureX, textureY, "lamp"); // Box 8 PRIME2-2
		bodyModel[293] = new ModelRendererTurbo(this, 132, 14, textureX, textureY, "lamp"); // Box 9 PRIME2-4
