...
public class Modelcq310_again extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public Modelcq310_again() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[146].setRotationPoint(-20F, 5F, 5F);

		bodyModel[147].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 25
		bodyModel[147].setRotationPoint(-20F, 5F, -5F);

		bodyModel[148].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 26
		bodyModel[148].setRotationPoint(-18F, 7F, -5F);
		...
		bodyModel[151].setRotationPoint(-25.5F, 5F, -7F);
		...
		bodyModel[152].setRotationPoint(-25F, 6F, -8F);
		...
		bodyModel[153].setRotationPoint(-25F, 8F, -10F);
		...
		bodyModel[154].setRotationPoint(-25.5F, 7.25F, -10F);

		bodyModel[155].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 158
		bodyModel[155].setRotationPoint(-23.5F, 5.5F, -6F);
		...
		bodyModel[162].setRotationPoint(-25.5F, 5.5F, 3F);

		bodyModel[163].addBox(0F, 0F, 0F, 2, 3, 3, 0F); // Box 166
		bodyModel[163].setRotationPoint(-23.5F, 5F, 4F);
		...
		bodyModel[165].setRotationPoint(-23F, 8F, 7F);
		...
		bodyModel[166].setRotationPoint(-23.5F, 7.25F, 8.75F);
		...
		bodyModel[168].setRotationPoint(15F, 5F, 5F);
		...
		bodyModel[169].setRotationPoint(22F, 6F, -8F);

		bodyModel[170].addBox(0F, 0F, 0F, 2, 3, 3, 0F); // Box 173
		bodyModel[170].setRotationPoint(21.5F, 5F, -7F);

		bodyModel[171].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 174
		bodyModel[171].setRotationPoint(23.5F, 5.5F, -6F);
		...
		bodyModel[174].setRotationPoint(15F, 5F, -5F);
		...
		bodyModel[175].setRotationPoint(21.5F, 7.25F, -10F);
		...
		bodyModel[176].setRotationPoint(22F, 8F, -10F);

		bodyModel[177].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 180
		bodyModel[177].setRotationPoint(17F, 7F, -5F);

		bodyModel[178].addBox(0F, 0F, 0F, 2, 3, 3, 0F); // Box 181
		bodyModel[178].setRotationPoint(23.5F, 5F, 4F);

		bodyModel[179].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 182
		bodyModel[179].setRotationPoint(21.5F, 5.5F, 3F);
		...
		bodyModel[180].setRotationPoint(24F, 6F, 7F);
		...
		bodyModel[181].setRotationPoint(23.5F, 7.25F, 8.75F);
		...
		bodyModel[182].setRotationPoint(24F, 8F, 7F);
	...
	public float[] getTrans() { return new float[]{0.0F, 0.155F, 0F}; }
}