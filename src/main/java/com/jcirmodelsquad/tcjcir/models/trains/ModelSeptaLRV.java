...
public class ModelSeptaLRV extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[452] = new ModelRendererTurbo(this, 0, 141, textureX, textureY); // Box 452
		bodyModel[453] = new ModelRendererTurbo(this, 0, 147, textureX, textureY); // Box 453
		bodyModel[454] = new ModelRendererTurbo(this, 0, 160, textureX, textureY); // Box 454
		bodyModel[455] = new ModelRendererTurbo(this, 0, 154, textureX, textureY); // Box 455
		...
		bodyModel[452].addBox(0F, 0F, 0F, 50, 1, 1, 0F); // Box 452
		bodyModel[452].setRotationPoint(-25F, 2.9F, -10.65F);

		bodyModel[453].addBox(0F, 0F, 0F, 50, 1, 1, 0F); // Box 453
		bodyModel[453].setRotationPoint(-25F, -3.5F, -10.65F);

		bodyModel[454].addBox(0F, 0F, 0F, 50, 1, 1, 0F); // Box 454
		bodyModel[454].setRotationPoint(-25F, 2.9F, 9.65F);
