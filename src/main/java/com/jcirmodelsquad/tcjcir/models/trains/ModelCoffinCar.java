...
public class ModelCoffinCar extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 256;

	public ModelCoffinCar() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[27] = new ModelRendererTurbo(this, 39, 40, textureX, textureY); // Box 28
		bodyModel[28] = new ModelRendererTurbo(this, 42, 66, textureX, textureY); // Box 29
		bodyModel[29] = new ModelRendererTurbo(this, 49, 93, textureX, textureY); // Box 30
		bodyModel[30] = new ModelRendererTurbo(this, 59, 34, textureX, textureY); // Box 31
		bodyModel[31] = new ModelRendererTurbo(this, 80, 30, textureX, textureY); // Box 32
		bodyModel[32] = new ModelRendererTurbo(this, 49, 110, textureX, textureY); // Box 33
		bodyModel[33] = new ModelRendererTurbo(this, 59, 34, textureX, textureY); // Box 34
		bodyModel[34] = new ModelRendererTurbo(this, 49, 118, textureX, textureY); // Box 36
		bodyModel[35] = new ModelRendererTurbo(this, 49, 118, textureX, textureY); // Box 37
		bodyModel[36] = new ModelRendererTurbo(this, 80, 30, textureX, textureY); // Box 38
		bodyModel[37] = new ModelRendererTurbo(this, 185, 10, textureX, textureY); // Box 39
		...
		bodyModel[27].addBox(0F, 0F, 0F, 60, 1, 20, 0F); // Box 28
		bodyModel[27].setRotationPoint(-30F, 1F, -10F);

		bodyModel[28].addBox(0F, 0F, 0F, 58, 5, 18, 0F); // Box 29
		bodyModel[28].setRotationPoint(-29F, -4F, -9F);

		bodyModel[29].addBox(0F, 0F, 0F, 58, 3, 12, 0F); // Box 30
		bodyModel[29].setRotationPoint(-29F, -7F, -6F);

		bodyModel[30].addShapeBox(0F, 0F, 0F, 58, 3, 2, 0F,0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 31
		bodyModel[30].setRotationPoint(-29F, -7F, -8F);

		bodyModel[31].addShapeBox(0F, 0F, 0F, 58, 2, 1, 0F,0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 32
		bodyModel[31].setRotationPoint(-29F, -6F, -9F);

		bodyModel[32].addShapeBox(0F, 0F, 0F, 58, 1, 4, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 33
		bodyModel[32].setRotationPoint(-29F, -8F, -2F);

		bodyModel[33].addShapeBox(0F, 0F, 0F, 58, 3, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 34
		bodyModel[33].setRotationPoint(-29F, -7F, 6F);

		bodyModel[34].addShapeBox(0F, 0F, 0F, 58, 1, 4, 0F,0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 36
		bodyModel[34].setRotationPoint(-29F, -8F, -6F);

		bodyModel[35].addShapeBox(0F, 0F, 0F, 58, 1, 4, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 37
		bodyModel[35].setRotationPoint(-29F, -8F, 2F);

		bodyModel[36].addShapeBox(0F, 0F, 0F, 58, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 38
		bodyModel[36].setRotationPoint(-29F, -6F, 8F);

		bodyModel[37].addBox(0F, 0F, 0F, 4, 8, 4, 0F); // Box 39
		bodyModel[37].setRotationPoint(-2F, -16F, -2F);
	}
