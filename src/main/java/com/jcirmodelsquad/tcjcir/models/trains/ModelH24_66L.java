...
public class ModelH24_66L extends ModelConverter //Same as Filename
{
	...
	public ModelH24_66L() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[169] = new ModelRendererTurbo(this, 95, 24, textureX, textureY, BoxName.lamp); // headlight F
		bodyModel[170] = new ModelRendererTurbo(this, 95, 30, textureX, textureY, BoxName.lamp); // headlight F
		...
		bodyModel[185] = new ModelRendererTurbo(this, 51, 42, textureX, textureY, BoxName.lamp); // marker light FL
		bodyModel[186] = new ModelRendererTurbo(this, 15, 42, textureX, textureY, BoxName.lamp); // marker light FR
		bodyModel[187] = new ModelRendererTurbo(this, 341, 303, textureX, textureY, BoxName.lamp); // marker light RL
		bodyModel[188] = new ModelRendererTurbo(this, 405, 303, textureX, textureY, BoxName.lamp); // marker light RR
		...
		bodyModel[191] = new ModelRendererTurbo(this, 49, 26, textureX, textureY, BoxName.lamp); // numberboard type 1 F
		bodyModel[192] = new ModelRendererTurbo(this, 11, 28, textureX, textureY, BoxName.lamp); // numberboard type 1 F
		...
		bodyModel[291] = new ModelRendererTurbo(this, 84, 50, textureX, textureY, BoxName.lamp); // headlight F
		bodyModel[292] = new ModelRendererTurbo(this, 88, 54, textureX, textureY, BoxName.lamp); // headlight F
		...
		bodyModel[300] = new ModelRendererTurbo(this, 83, 13, textureX, textureY, BoxName.lamp); // headlight R
		bodyModel[301] = new ModelRendererTurbo(this, 81, 24, textureX, textureY, BoxName.lamp); // headlight R
		...
		bodyModel[306] = new ModelRendererTurbo(this, 47, 22, textureX, textureY, BoxName.lamp); // numberboard type 2 F
		bodyModel[307] = new ModelRendererTurbo(this, 12, 13, textureX, textureY, BoxName.lamp); // numberboard type 2 F
		bodyModel[308] = new ModelRendererTurbo(this, 396, 304, textureX, textureY, BoxName.lamp); // numberboard type 2 R
		bodyModel[309] = new ModelRendererTurbo(this, 344, 304, textureX, textureY, BoxName.lamp); // numberboard type 2 R
		...
		bodyModel[372] = new ModelRendererTurbo(this, 396, 302, textureX, textureY, BoxName.lamp); // numberboard type 1 R
		bodyModel[373] = new ModelRendererTurbo(this, 346, 302, textureX, textureY, BoxName.lamp); // numberboard type 1 R
		...
		bodyModel[392] = new ModelRendererTurbo(this, 466, 300, textureX, textureY, BoxName.lamp); // headlight R
		bodyModel[393] = new ModelRendererTurbo(this, 466, 305, textureX, textureY, BoxName.lamp); // headlight R
