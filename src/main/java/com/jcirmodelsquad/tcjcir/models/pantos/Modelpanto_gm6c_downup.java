...
public class Modelpanto_gm6c_downup extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 64;

	public Modelpanto_gm6c_downup() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[28] = new ModelRendererTurbo(this, 18, 5, textureX, textureY, "cull"); // Box 105 cull
		bodyModel[29] = new ModelRendererTurbo(this, 18, 9, textureX, textureY, "cull"); // Box 110 cull
		bodyModel[30] = new ModelRendererTurbo(this, 13, 28, textureX, textureY); // Box 2
		bodyModel[31] = new ModelRendererTurbo(this, 12, 26, textureX, textureY); // Box 3
		bodyModel[32] = new ModelRendererTurbo(this, 38, 26, textureX, textureY, "cull"); // Cull arm rotaty
		bodyModel[33] = new ModelRendererTurbo(this, 35, 5, textureX, textureY); // Head collector
		bodyModel[34] = new ModelRendererTurbo(this, 13, 5, textureX, textureY); // Head collector
		bodyModel[35] = new ModelRendererTurbo(this, 1, 14, textureX, textureY, "cull"); // Cull top arm
		bodyModel[36] = new ModelRendererTurbo(this, 42, 4, textureX, textureY, "cull"); // Head collector cull
		bodyModel[37] = new ModelRendererTurbo(this, 1, 3, textureX, textureY, "cull"); // Head collector cull
		bodyModel[38] = new ModelRendererTurbo(this, 18, 5, textureX, textureY, "cull"); // Box 107 cull
		...
		bodyModel[20].rotateAngleZ = -2.53072742F;
		...
		bodyModel[21].rotateAngleZ = -2.54818071F;
		...
		bodyModel[22].setRotationPoint(-11F, -25.5F, 0F);
		...
		bodyModel[23].setRotationPoint(-22.51F, -39F, 4F);
		...
		bodyModel[24].setRotationPoint(-22.51F, -39F, -5F);
		...
		bodyModel[25].setRotationPoint(-11F, -27.5F, 0F);
		bodyModel[25].rotateAngleZ = 2.39110108F;
		...
		bodyModel[26].setRotationPoint(-22.5F, -39.01F, -5F);

		bodyModel[27].addShapeBox(-6F, -1.5F, 0F, 1, 1, 6, 0F,0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, 0F, -0.25F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.25F); // Head collector cull
		bodyModel[27].setRotationPoint(-11F, -27.5F, -3F);
		bodyModel[27].rotateAngleZ = -0.75049158F;

		bodyModel[28].addShapeBox(0F, -0.5F, 0F, 5, 1, 2, 0F,0F, 0F, 0.4F, 0.5F, -0.75F, -0.1F, 0.5F, -0.75F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0.4F, 0.5F, 0.75F, -0.1F, 0.5F, 0.75F, -0.5F, 0F, 0F, 0F); // Box 105 cull
		bodyModel[28].setRotationPoint(-11F, -27.5F, -0.8F);
		bodyModel[28].rotateAngleZ = 2.39110108F;

		bodyModel[29].addShapeBox(5.5F, -0.5F, 0F, 6, 1, 1, 0F,0F, -0.75F, 1.375F, 0F, 0F, 4.75F, 0F, 0F, 2.375F, 0F, -0.75F, -1F, 0F, 0.75F, 1.375F, 0F, 0F, 4.75F, 0F, 0F, 2.375F, 0F, 0.75F, -1F); // Box 110 cull
		bodyModel[29].setRotationPoint(-11F, -27.5F, 0.7F);
		bodyModel[29].rotateAngleZ = 2.39110108F;

		bodyModel[30].addShapeBox(-10F, -0.5F, -0.5F, 11, 1, 1, 0F,0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F); // Box 2
		bodyModel[30].setRotationPoint(-29.4F, -20.5F, 0F);

		bodyModel[31].addShapeBox(-13F, 0F, -0.5F, 13, 0, 1, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F); // Box 3
		bodyModel[31].setRotationPoint(-26.6F, -21.5F, 0F);
		bodyModel[31].rotateAngleZ = -0.01745329F;

		bodyModel[32].addShapeBox(-0.5F, -3F, -1.5F, 1, 3, 3, 0F,0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0F, -0.35F); // Cull arm rotaty
		bodyModel[32].setRotationPoint(-39F, -20.5F, 0F);

		bodyModel[33].addShapeBox(0F, 0F, 0F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Head collector
		bodyModel[33].setRotationPoint(-25.49F, -24.49F, -5F);

		bodyModel[34].addShapeBox(0F, 0F, 0F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Head collector
		bodyModel[34].setRotationPoint(-25.49F, -24.49F, 4F);

		bodyModel[35].addShapeBox(0F, -0.5F, -5F, 15, 1, 10, 0F,0F, 0F, -3.775F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3.775F, 0F, 0F, -3.775F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3.775F); // Cull top arm
		bodyModel[35].setRotationPoint(-39.5F, -23F, 0F);

		bodyModel[36].addShapeBox(0F, 0F, 0F, 1, 4, 10, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 4F, 0F, -1F, 4F, 0F, -1F, 4F, 0F, -1F, 4F); // Head collector cull
		bodyModel[36].setRotationPoint(-25.5F, -24.5F, -5F);

		bodyModel[37].addShapeBox(5F, -1.5F, 0F, 1, 1, 6, 0F,0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, 0F, -0.5F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.5F); // Head collector cull
		bodyModel[37].setRotationPoint(-39.5F, -23F, -3F);

		bodyModel[38].addShapeBox(0F, -0.5F, 0F, 5, 1, 2, 0F,0F, 0F, 0F, 0.5F, 0.75F, -0.5F, 0.5F, 0.75F, -0.1F, 0F, 0F, 0.4F, 0F, 0F, 0F, 0.5F, -0.75F, -0.5F, 0.5F, -0.75F, -0.1F, 0F, 0F, 0.4F); // Box 107 cull
		bodyModel[38].setRotationPoint(-39.5F, -23F, -1.2F);
		...
		bodyModel[39].setRotationPoint(-39.5F, -23F, -0.699999999999999F);
	}
	@Override
